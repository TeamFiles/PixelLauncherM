...
# direct methods
.method public static a(Landroid/content/ContentResolver;Landroid/net/Uri;)Lg0/b;
    .locals 2
    ...
    invoke-direct {p1, p0}, Lg0/b;-><init>(Landroid/content/ContentProviderClient;)V
...
.method public static c(Landroid/content/Context;Landroid/net/Uri;Ljava/util/Set;)Landroidx/slice/Slice;
    ...
    invoke-static {v0, p1}, Lg0/c;->a(Landroid/content/ContentResolver;Landroid/net/Uri;)Lg0/b;

    move-result-object v0

    .line 2
    iget-object v1, v0, Lg0/b;->b:Landroid/content/ContentProviderClient;
    ...
    .line 5
    invoke-static {v1, p2}, Lg0/c;->b(Landroid/os/Bundle;Ljava/util/Set;)V

    .line 6
    iget-object p1, v0, Lg0/b;->b:Landroid/content/ContentProviderClient;
    ...
    .line 7
    invoke-static {p0, p1}, Lg0/c;->e(Landroid/content/Context;Landroid/os/Bundle;)Landroidx/slice/Slice;
    ...
    .line 8
    invoke-virtual {v0}, Lg0/b;->close()V
...
.method public static d(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;Landroid/net/Uri;)V
    ...
    .line 2
    :try_start_0
    invoke-static {p0, p3}, Lg0/c;->a(Landroid/content/ContentResolver;Landroid/net/Uri;)Lg0/b;
    ...
    .line 7
    iget-object p1, p0, Lg0/b;->b:Landroid/content/ContentProviderClient;
    ...
    .line 8
    :try_start_2
    invoke-virtual {p0}, Lg0/b;->close()V
    :try_end_2
...
.method public static e(Landroid/content/Context;Landroid/os/Bundle;)Landroidx/slice/Slice;
    ...
    invoke-direct {v2, p0}, Lg0/a;-><init>(Landroid/content/Context;)V

    sput-object v2, Landroidx/slice/SliceItemHolder;->j:Lf0/f;
    ...
    .line 5
    :try_start_1
    sput-object v0, Landroidx/slice/SliceItemHolder;->j:Lf0/f;
    ...
    :cond_2
    :try_start_4
    invoke-static {p0}, Ln0/b;->a(Landroid/os/Parcelable;)Ln0/f;
...
.method public static f(Landroid/content/Context;Landroid/net/Uri;Ljava/util/Set;)V
    ...
    .line 7
    iget-object p0, v0, Lg0/b;->b:Landroid/content/ContentProviderClient;
