...
.method public constructor <init>(Landroid/content/Context;Lcom/android/launcher3/util/ComponentKey;Landroid/content/pm/ShortcutInfo;Landroid/graphics/Rect;)V
    ...
    .line 2
    iput-object p1, p0, LH1/K;->b:Landroid/content/Context;

    .line 3
    iput-object p2, p0, LH1/K;->c:Lcom/android/launcher3/util/ComponentKey;

    .line 4
    iput-object p3, p0, LH1/K;->e:Landroid/content/pm/ShortcutInfo;
    ...
    iput-object p2, p0, LH1/K;->f:Lcom/android/launcher3/icons/BitmapInfo;
    ...
    iput-object p4, p0, LH1/K;->d:Lcom/android/launcher3/model/data/WorkspaceItemInfo;
...
.method public static synthetic a(LH1/K;)Lcom/android/launcher3/model/data/WorkspaceItemInfo;
    .locals 0

    .line 1
    iget-object p0, p0, LH1/K;->d:Lcom/android/launcher3/model/data/WorkspaceItemInfo;

    return-object p0
.end method

.method public static synthetic b(LH1/K;)Lcom/android/launcher3/Launcher;
    .locals 0
...
.method public static synthetic c(LH1/K;)Lcom/android/launcher3/icons/BitmapInfo;
    .locals 0

    .line 1
    iget-object p0, p0, LH1/K;->f:Lcom/android/launcher3/icons/BitmapInfo;

    return-object p0
.end method

.method public static synthetic d(LH1/K;)Landroid/content/pm/ShortcutInfo;
    .locals 0

    .line 1
    iget-object p0, p0, LH1/K;->e:Landroid/content/pm/ShortcutInfo;

    return-object p0
.end method

.method public static synthetic e(LH1/K;)Landroid/content/Context;
    .locals 0

    .line 1
    iget-object p0, p0, LH1/K;->b:Landroid/content/Context;
...
.method public createDragHelper()Lcom/android/launcher3/widget/PendingItemDragHelper;
    ...
    iget-object v3, p0, LH1/K;->c:Lcom/android/launcher3/util/ComponentKey;
    ...
    invoke-direct {v2, p0, v4, v3}, LH1/J;-><init>(LH1/K;Landroid/content/ComponentName;Landroid/os/UserHandle;)V
