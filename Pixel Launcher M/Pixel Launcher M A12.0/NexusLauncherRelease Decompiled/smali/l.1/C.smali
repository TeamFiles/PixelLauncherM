...
.method public final a()Ll/A;
    ...
    invoke-virtual {v0, v1}, Ll/A;->l(Ll/q;)V

    .line 12
    iget-object v1, p0, Ll/C;->l:Landroid/widget/PopupWindow$OnDismissListener;

    invoke-virtual {v0, v1}, Ll/A;->u(Landroid/widget/PopupWindow$OnDismissListener;)V

    .line 13
    iget-object v1, p0, Ll/C;->f:Landroid/view/View;

    invoke-virtual {v0, v1}, Ll/A;->p(Landroid/view/View;)V

    .line 14
    iget-object v1, p0, Ll/C;->i:Ll/D;

    invoke-interface {v0, v1}, Ll/E;->d(Ll/D;)V

    .line 15
    iget-boolean v1, p0, Ll/C;->h:Z

    invoke-virtual {v0, v1}, Ll/A;->r(Z)V

    .line 16
    iget p0, p0, Ll/C;->g:I

    invoke-virtual {v0, p0}, Ll/A;->s(I)V
...
.method public j(Ll/D;)V
    ...
    .line 3
    invoke-interface {p0, p1}, Ll/E;->d(Ll/D;)V
...
.method public final l(IIZZ)V
    ...
    .line 2
    invoke-virtual {v0, p4}, Ll/A;->v(Z)V
    ...
    .line 4
    invoke-static {p4}, LL/N;->C(Landroid/view/View;)I

    move-result p4

    .line 5
    invoke-static {p3, p4}, LL/i;->b(II)I
    ...
    .line 7
    :cond_0
    invoke-virtual {v0, p1}, Ll/A;->t(I)V

    .line 8
    invoke-virtual {v0, p2}, Ll/A;->w(I)V
    ...
    .line 11
    invoke-virtual {v0, p3}, Ll/A;->q(Landroid/graphics/Rect;)V
