...
.method public declared-synchronized addItem(Landroid/content/Context;Lcom/android/launcher3/model/data/ItemInfo;Z)V
    ...
    invoke-virtual {v2, v0}, Lcom/android/launcher3/util/IntSparseArrayMap;->containsKey(I)Z
    ...
    .line 10
    :cond_4
    invoke-virtual {p0, v0}, Lcom/android/launcher3/model/BgDataModel;->findOrMakeFolder(I)Lcom/android/launcher3/model/data/FolderInfo;
    ...
    invoke-virtual {v0, v2, v3}, Lcom/android/launcher3/model/data/FolderInfo;->add(Lcom/android/launcher3/model/data/WorkspaceItemInfo;Z)V
...
.method public declared-synchronized removeItem(Landroid/content/Context;Ljava/lang/Iterable;)V
    ...
    invoke-direct {p2, p0, p1}, LE0/E;-><init>(Lcom/android/launcher3/model/BgDataModel;Landroid/content/Context;)V
...
.method public declared-synchronized updateShortcutPinnedState(Landroid/content/Context;Landroid/os/UserHandle;)V
    ...
    invoke-direct {v2, v1}, LE0/F;-><init>(Ljava/util/stream/Stream$Builder;)V
    ...
    invoke-direct {v1, p1, p2}, LE0/D;-><init>(Landroid/content/Context;Landroid/os/UserHandle;)V
