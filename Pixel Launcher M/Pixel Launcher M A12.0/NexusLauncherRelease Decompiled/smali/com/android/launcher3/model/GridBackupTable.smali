...
.method public backupOrRestoreAsNeeded()Z
    ...
    .line 2
    iget-object v0, p0, Lcom/android/launcher3/model/GridBackupTable;->mContext:Landroid/content/Context;
    ...
    invoke-virtual {p0, v0, v1, v2}, Lcom/android/launcher3/model/GridBackupTable;->doBackup(JI)V
    ...
    .line 7
    invoke-virtual {p0, v0}, Lcom/android/launcher3/model/GridBackupTable;->restoreIfBackupExists(Ljava/lang/String;)Z
...
.method public getRestoreHotseatAndGridSize(Landroid/graphics/Point;)I
    ...
    .line 1
    iget v0, p0, Lcom/android/launcher3/model/GridBackupTable;->mRestoredGridX:I

    iget v1, p0, Lcom/android/launcher3/model/GridBackupTable;->mRestoredGridY:I

    invoke-virtual {p1, v0, v1}, Landroid/graphics/Point;->set(II)V

    .line 2
    iget p0, p0, Lcom/android/launcher3/model/GridBackupTable;->mRestoredHotseatSize:I
...
.method public final restoreIfBackupExists(Ljava/lang/String;)Z
    .locals 3
    ...
    invoke-static {p0, v2, p1, v0, v1}, Lcom/android/launcher3/model/GridBackupTable;->copyTable(Landroid/database/sqlite/SQLiteDatabase;Ljava/lang/String;Ljava/lang/String;J)V

    const-string p0, "GridBackupTable"

    const-string p1, "Backup table found"
...
.method public restoreToPreviewIfBackupExists()Z
    .locals 2
    ...
    :cond_0
    const-string v0, "favorites_preview"
