...
.method private ensureQueueLoaded()V
    ...
    invoke-direct {v2, p0}, LK0/M;-><init>(Lcom/android/launcher3/model/ItemInstallQueue;)V
...
.method private flushInstallQueue()V
    ...
    invoke-direct {v1, p0}, LK0/L;-><init>(Lcom/android/launcher3/model/ItemInstallQueue;)V
...
.method private flushQueueInBackground()V
    ...
    invoke-direct {v3, p0}, Lcom/android/launcher3/model/l;-><init>(Lcom/android/launcher3/model/ItemInstallQueue;)V
...
.method private queuePendingShortcutInfo(Lcom/android/launcher3/model/ItemInstallQueue$PendingInstallShortcutInfo;)V
    ...
    invoke-direct {v2, p0, p1, v0}, Lcom/android/launcher3/model/k;-><init>(Lcom/android/launcher3/model/ItemInstallQueue;Lcom/android/launcher3/model/ItemInstallQueue$PendingInstallShortcutInfo;Ljava/lang/Exception;)V
...
.method public getPendingShortcuts(Landroid/os/UserHandle;)Ljava/util/stream/Stream;
    ...
    new-instance v0, Lcom/android/launcher3/model/n;

    invoke-direct {v0, p1}, Lcom/android/launcher3/model/n;-><init>(Landroid/os/UserHandle;)V
    ...
    invoke-direct {v0, p1}, Lcom/android/launcher3/model/o;-><init>(Landroid/os/UserHandle;)V
...
.method public removeFromInstallQueue(Ljava/util/HashSet;Landroid/os/UserHandle;)V
    ...
    invoke-direct {v1, p2, p1}, Lcom/android/launcher3/model/m;-><init>(Landroid/os/UserHandle;Ljava/util/HashSet;)V
