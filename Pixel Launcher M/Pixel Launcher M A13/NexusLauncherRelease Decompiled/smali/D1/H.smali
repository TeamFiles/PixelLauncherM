...
.method public constructor <init>(Landroid/content/Context;Lcom/android/launcher3/util/ComponentKey;Landroid/content/pm/ShortcutInfo;Landroid/graphics/Rect;)V
    ...
    iput-object p1, p0, LD1/H;->b:Landroid/content/Context;

    iput-object p2, p0, LD1/H;->c:Lcom/android/launcher3/util/ComponentKey;

    iput-object p3, p0, LD1/H;->e:Landroid/content/pm/ShortcutInfo;
    ...
    iput-object p2, p0, LD1/H;->f:Lcom/android/launcher3/icons/BitmapInfo;
    ...
    iput-object p4, p0, LD1/H;->d:Lcom/android/launcher3/model/data/WorkspaceItemInfo;
...
.method public static bridge synthetic a(LD1/H;)Lcom/android/launcher3/icons/BitmapInfo;
    .locals 0

    iget-object p0, p0, LD1/H;->f:Lcom/android/launcher3/icons/BitmapInfo;

    return-object p0
.end method

.method public static bridge synthetic b(LD1/H;)Landroid/content/Context;
    .locals 0

    iget-object p0, p0, LD1/H;->b:Landroid/content/Context;

    return-object p0
.end method

.method public static bridge synthetic c(LD1/H;)Lcom/android/launcher3/model/data/WorkspaceItemInfo;
    .locals 0

    iget-object p0, p0, LD1/H;->d:Lcom/android/launcher3/model/data/WorkspaceItemInfo;

    return-object p0
.end method

.method public static bridge synthetic d(LD1/H;)Landroid/content/pm/ShortcutInfo;
    .locals 0

    iget-object p0, p0, LD1/H;->e:Landroid/content/pm/ShortcutInfo;

    return-object p0
.end method

.method public static synthetic e(LD1/H;)Lcom/android/launcher3/Launcher;
    .locals 0
...
.method public createDragHelper()Lcom/android/launcher3/widget/PendingItemDragHelper;
    ...
    iget-object v3, p0, LD1/H;->c:Lcom/android/launcher3/util/ComponentKey;
    ...
    invoke-direct {v2, p0, v4, v3}, LD1/G;-><init>(LD1/H;Landroid/content/ComponentName;Landroid/os/UserHandle;)V
