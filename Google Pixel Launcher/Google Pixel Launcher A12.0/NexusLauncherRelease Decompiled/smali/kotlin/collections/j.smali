...
.method public static final e(Ljava/util/Map;)Ljava/util/Map;
    ...
    .line 2
    :cond_0
    invoke-static {p0}, Lkotlin/collections/i;->c(Ljava/util/Map;)Ljava/util/Map;
...
.method public static final g(Ljava/lang/Iterable;)Ljava/util/Map;
    ...
    invoke-static {v0}, Lkotlin/collections/i;->a(I)I

    move-result v0

    invoke-direct {v1, v0}, Ljava/util/LinkedHashMap;-><init>(I)V

    invoke-static {p0, v1}, Lkotlin/collections/j;->h(Ljava/lang/Iterable;Ljava/util/Map;)Ljava/util/Map;
    ...
    invoke-static {p0}, Lkotlin/collections/i;->b(Lkotlin/Pair;)Ljava/util/Map;
    ...
    invoke-static {p0, v0}, Lkotlin/collections/j;->h(Ljava/lang/Iterable;Ljava/util/Map;)Ljava/util/Map;

    move-result-object p0

    invoke-static {p0}, Lkotlin/collections/j;->e(Ljava/util/Map;)Ljava/util/Map;
...
.method public static final h(Ljava/lang/Iterable;Ljava/util/Map;)Ljava/util/Map;
    ...
    .line 1
    invoke-static {p1, p0}, Lkotlin/collections/j;->f(Ljava/util/Map;Ljava/lang/Iterable;)V
