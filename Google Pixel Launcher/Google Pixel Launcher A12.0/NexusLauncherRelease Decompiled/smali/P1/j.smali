...
.method public constructor <init>(Landroid/content/Context;Lcom/android/launcher3/popup/PopupDataProvider;)V
    ...
    .line 2
    iput-object p1, p0, LP1/j;->a:Landroid/content/Context;

    .line 3
    iput-object p2, p0, LP1/j;->b:Lcom/android/launcher3/popup/PopupDataProvider;
    ...
    iput-object p1, p0, LP1/j;->c:Landroid/os/Handler;
    ...
    invoke-direct {p2, p0}, LP1/b;-><init>(LP1/j;)V
...
.method public static synthetic a(LP1/j;Landroid/app/search/SearchSession;)V
    .locals 0

    invoke-direct {p0, p1}, LP1/j;->o(Landroid/app/search/SearchSession;)V

    return-void
.end method

.method public static synthetic b(LP1/j;)V
    .locals 0

    invoke-virtual {p0}, LP1/j;->m()V
...
.method public static synthetic c(Ljava/util/Set;Ljava/util/Set;Lcom/android/launcher3/model/WidgetItem;)Z
    ...
    invoke-static {p0, p1, p2}, LP1/j;->n(Ljava/util/Set;Ljava/util/Set;Lcom/android/launcher3/model/WidgetItem;)Z
...
.method public static synthetic d(LP1/j;Ljava/util/Set;Ljava/util/Set;Ljava/util/Set;Ljava/util/ArrayList;Lcom/android/launcher3/widget/model/WidgetsListBaseEntry;)V
    .locals 0

    invoke-direct/range {p0 .. p5}, LP1/j;->r(Ljava/util/Set;Ljava/util/Set;Ljava/util/Set;Ljava/util/ArrayList;Lcom/android/launcher3/widget/model/WidgetsListBaseEntry;)V

    return-void
.end method

.method public static synthetic e(LP1/j;)V
    .locals 0

    invoke-virtual {p0}, LP1/j;->k()V
...
.method public static synthetic f(Ljava/util/Set;Ljava/util/Set;Ljava/util/Set;Landroid/app/search/SearchTarget;)V
    ...
    invoke-static {p0, p1, p2, p3}, LP1/j;->p(Ljava/util/Set;Ljava/util/Set;Ljava/util/Set;Landroid/app/search/SearchTarget;)V
...
.method public static synthetic g(Lcom/android/launcher3/widget/model/WidgetsListBaseEntry;)Z
    ...
    invoke-static {p0}, LP1/j;->q(Lcom/android/launcher3/widget/model/WidgetsListBaseEntry;)Z
...
.method public static synthetic h(LP1/j;)Landroid/os/Handler;
    .locals 0

    .line 1
    iget-object p0, p0, LP1/j;->c:Landroid/os/Handler;

    return-object p0
.end method

.method public static synthetic i(LP1/j;Ljava/util/List;)Ljava/util/ArrayList;
    .locals 0

    .line 1
    invoke-virtual {p0, p1}, LP1/j;->s(Ljava/util/List;)Ljava/util/ArrayList;
...
.method public static synthetic j(LP1/j;)Lcom/android/launcher3/popup/PopupDataProvider;
    .locals 0

    .line 1
    iget-object p0, p0, LP1/j;->b:Lcom/android/launcher3/popup/PopupDataProvider;
...
.method private synthetic o(Landroid/app/search/SearchSession;)V
    ...
    .line 1
    iput-object p1, p0, LP1/j;->e:Landroid/app/search/SearchSession;
...
.method private synthetic r(Ljava/util/Set;Ljava/util/Set;Ljava/util/Set;Ljava/util/ArrayList;Lcom/android/launcher3/widget/model/WidgetsListBaseEntry;)V
    ...
    .line 2
    invoke-virtual/range {v0 .. v5}, LP1/j;->l(Lcom/android/launcher3/util/PackageUserKey;Ljava/util/List;Ljava/util/Set;Ljava/util/Set;Ljava/util/Set;)Ljava/util/List;
...
.method public cancel(Z)V
    ...
    .line 1
    iget-object p0, p0, LP1/j;->d:LP1/i;

    if-eqz p0, :cond_0

    .line 2
    invoke-virtual {p0}, LP1/i;->b()V
...
.method public destroy()V
    ...
    .line 1
    iget-object v0, p0, LP1/j;->c:Landroid/os/Handler;
    ...
    invoke-direct {v1, p0}, LP1/c;-><init>(LP1/j;)V
...
.method public doSearch(Ljava/lang/String;Lcom/android/launcher3/search/SearchCallback;)V
    ...
    .line 2
    invoke-virtual {v0}, LP1/i;->b()V

    .line 3
    :cond_0
    new-instance v0, LP1/i;

    invoke-direct {v0, p0, p1, p2}, LP1/i;-><init>(LP1/j;Ljava/lang/String;Lcom/android/launcher3/search/SearchCallback;)V

    iput-object v0, p0, LP1/j;->d:LP1/i;

    .line 4
    iget-object p1, p0, LP1/j;->e:Landroid/app/search/SearchSession;

    if-nez p1, :cond_1

    .line 5
    invoke-virtual {v0}, LP1/i;->c()V

    goto :goto_0

    .line 6
    :cond_1
    iget-object p1, p0, LP1/j;->c:Landroid/os/Handler;

    invoke-static {v0}, Ljava/util/Objects;->requireNonNull(Ljava/lang/Object;)Ljava/lang/Object;

    new-instance p2, LP1/a;

    invoke-direct {p2, v0}, LP1/a;-><init>(LP1/i;)V
    ...
    iget-object p2, p0, LP1/i;->c:Landroid/app/search/Query;
...
.method public final k()V
    ...
    .line 1
    iget-object v0, p0, LP1/j;->f:Landroid/app/search/SearchSession;
    ...
    .line 3
    iput-object v0, p0, LP1/j;->f:Landroid/app/search/SearchSession;
...
.method public final l(Lcom/android/launcher3/util/PackageUserKey;Ljava/util/List;Ljava/util/Set;Ljava/util/Set;Ljava/util/Set;)Ljava/util/List;
    ...
    invoke-direct {p1, p4, p5}, LP1/g;-><init>(Ljava/util/Set;Ljava/util/Set;)V
...
.method public final m()V
    ...
    .line 7
    iget-object v1, p0, LP1/j;->c:Landroid/os/Handler;

    new-instance v2, LP1/d;

    invoke-direct {v2, p0, v0}, LP1/d;-><init>(LP1/j;Landroid/app/search/SearchSession;)V
...
.method public final s(Ljava/util/List;)Ljava/util/ArrayList;
    ...
    invoke-direct {v0, v2, v3, v4}, LP1/f;-><init>(Ljava/util/Set;Ljava/util/Set;Ljava/util/Set;)V

    invoke-interface {p1, v0}, Ljava/util/List;->forEach(Ljava/util/function/Consumer;)V

    .line 6
    iget-object p1, p0, LP1/j;->b:Lcom/android/launcher3/popup/PopupDataProvider;
    ...
    invoke-direct/range {v0 .. v5}, LP1/e;-><init>(LP1/j;Ljava/util/Set;Ljava/util/Set;Ljava/util/Set;Ljava/util/ArrayList;)V
