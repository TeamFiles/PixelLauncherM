...
.method private constructor <init>(Landroid/content/Context;ILandroid/content/ComponentName;Landroid/view/SurfaceControl;Landroid/graphics/Rect;Landroid/graphics/Rect;Landroid/graphics/Matrix;Landroid/graphics/RectF;Landroid/graphics/Rect;ILandroid/graphics/Rect;ILandroid/view/View;)V
    ...
    invoke-direct {p0, v3, v5, p1}, Lcom/android/quickstep/util/RectFSpringAnim;-><init>(Landroid/graphics/RectF;Landroid/graphics/RectF;Landroid/content/Context;)V
    ...
    iput-object v6, v0, Lcom/android/quickstep/util/SwipePipToHomeAnimator;->mHomeToWindowPositionMap:Landroid/graphics/Matrix;
    ...
    iput-object v7, v0, Lcom/android/quickstep/util/SwipePipToHomeAnimator;->mStartBounds:Landroid/graphics/Rect;
    ...
    iput-object v8, v0, Lcom/android/quickstep/util/SwipePipToHomeAnimator;->mCurrentBoundsF:Landroid/graphics/RectF;
    ...
    iput-object v8, v0, Lcom/android/quickstep/util/SwipePipToHomeAnimator;->mCurrentBounds:Landroid/graphics/Rect;
    ...
    iput-object v8, v0, Lcom/android/quickstep/util/SwipePipToHomeAnimator;->mDestinationBounds:Landroid/graphics/Rect;
    ...
    iput-object v9, v0, Lcom/android/quickstep/util/SwipePipToHomeAnimator;->mInsetsEvaluator:Landroid/animation/RectEvaluator;
    ...
    iput-object v9, v0, Lcom/android/quickstep/util/SwipePipToHomeAnimator;->mSourceInsets:Landroid/graphics/Rect;
    ...
    iput-object v9, v0, Lcom/android/quickstep/util/SwipePipToHomeAnimator;->mDestinationBoundsTransformed:Landroid/graphics/Rect;

    move v10, p2

    .line 12
    iput v10, v0, Lcom/android/quickstep/util/SwipePipToHomeAnimator;->mTaskId:I

    move-object v10, p3

    .line 13
    iput-object v10, v0, Lcom/android/quickstep/util/SwipePipToHomeAnimator;->mComponentName:Landroid/content/ComponentName;
    ...
    .line 24
    iput-object v4, v0, Lcom/android/quickstep/util/SwipePipToHomeAnimator;->mSourceHintRectInsets:Landroid/graphics/Rect;
    ...
    invoke-virtual {v2, v3, p4}, Landroid/view/SurfaceControl$Transaction;->reparent(Landroid/view/SurfaceControl;Landroid/view/SurfaceControl;)Landroid/view/SurfaceControl$Transaction;
    ...
    invoke-direct {v1, p0, v2}, Lk1/A;-><init>(Lcom/android/quickstep/util/SwipePipToHomeAnimator;Landroid/view/SurfaceControl$Transaction;)V
    ...
    invoke-direct {v1, p0}, Lk1/z;-><init>(Lcom/android/quickstep/util/SwipePipToHomeAnimator;)V
...
.method public static synthetic e(Lcom/android/quickstep/util/SwipePipToHomeAnimator;Landroid/view/SurfaceControl$Transaction;Lcom/android/quickstep/util/AppCloseConfig;Landroid/graphics/RectF;F)V
    .locals 0

    invoke-direct {p0, p1, p2, p3, p4}, Lcom/android/quickstep/util/SwipePipToHomeAnimator;->lambda$new$0(Landroid/view/SurfaceControl$Transaction;Lcom/android/quickstep/util/AppCloseConfig;Landroid/graphics/RectF;F)V

    return-void
.end method

.method public static synthetic f(Lcom/android/quickstep/util/SwipePipToHomeAnimator;Lcom/android/quickstep/util/AppCloseConfig;Landroid/graphics/RectF;F)V
    .locals 0

    invoke-direct {p0, p1, p2, p3}, Lcom/android/quickstep/util/SwipePipToHomeAnimator;->onAnimationUpdate(Lcom/android/quickstep/util/AppCloseConfig;Landroid/graphics/RectF;F)V
...
.method private getRotatedPosition(F)Lcom/android/quickstep/util/SwipePipToHomeAnimator$RotatedPosition;
    ...
    invoke-direct {p0, v0, v2, p1, v1}, Lcom/android/quickstep/util/SwipePipToHomeAnimator$RotatedPosition;-><init>(FFFLcom/android/quickstep/util/SwipePipToHomeAnimator$1;)V

    return-object p0
.end method

.method private synthetic lambda$new$0(Landroid/view/SurfaceControl$Transaction;Lcom/android/quickstep/util/AppCloseConfig;Landroid/graphics/RectF;F)V
    .locals 6
...
.method private onAnimationUpdate(Lcom/android/quickstep/util/AppCloseConfig;Landroid/graphics/RectF;F)V
    .locals 2

    .line 1
    iget-boolean p1, p0, Lcom/android/quickstep/util/SwipePipToHomeAnimator;->mHasAnimationEnded:Z
    ...
    .line 3
    iget-object v0, p0, Lcom/android/quickstep/util/SwipePipToHomeAnimator;->mHomeToWindowPositionMap:Landroid/graphics/Matrix;
    ...
    .line 4
    iget-object p2, p0, Lcom/android/quickstep/util/SwipePipToHomeAnimator;->mCurrentBoundsF:Landroid/graphics/RectF;

    invoke-direct {p0, p1, p2, p3}, Lcom/android/quickstep/util/SwipePipToHomeAnimator;->onAnimationUpdate(Landroid/view/SurfaceControl$Transaction;Landroid/graphics/RectF;F)Landroid/window/PictureInPictureSurfaceTransaction;
