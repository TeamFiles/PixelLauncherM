...
.method public final isSplitSelectionState(Lcom/android/launcher3/LauncherState;)Z
    .locals 0
...
.method public final setAlphas(Lcom/android/launcher3/anim/PropertySetter;Lcom/android/launcher3/states/StateAnimationConfig;Lcom/android/launcher3/LauncherState;)V
    ...
    .line 5
    invoke-virtual {v0, p3}, Lcom/android/quickstep/views/RecentsView;->shouldShowOverviewActionsForState(Lcom/android/launcher3/statemanager/BaseState;)Z
    ...
    invoke-virtual {v0}, Lcom/android/launcher3/BaseQuickstepLauncher;->getActionsView()Lcom/android/quickstep/views/OverviewActionsView;
    ...
    .line 8
    invoke-interface {p1, v0, v3, v1, p2}, Lcom/android/launcher3/anim/PropertySetter;->setFloat(Ljava/lang/Object;Landroid/util/FloatProperty;FLandroid/animation/TimeInterpolator;)V
    ...
    invoke-virtual {p3, p2, v0}, Lcom/android/launcher3/LauncherState;->areElementsVisible(Lcom/android/launcher3/Launcher;I)Z
    ...
    sget-object p2, Lcom/android/quickstep/views/SplitPlaceholderView;->ALPHA_FLOAT:Landroid/util/FloatProperty;

    invoke-interface {p1, p0, p2, v2, v5}, Lcom/android/launcher3/anim/PropertySetter;->setFloat(Ljava/lang/Object;Landroid/util/FloatProperty;FLandroid/animation/TimeInterpolator;)V
...
.method public setStateWithAnimationInternal(Lcom/android/launcher3/LauncherState;Lcom/android/launcher3/states/StateAnimationConfig;Lcom/android/launcher3/anim/PendingAnimation;)V
    ...
    invoke-direct {v0, p0}, LT0/g;-><init>(Lcom/android/launcher3/uioverrides/RecentsViewStateController;)V
    ...
    invoke-direct {v1, v0}, LT0/h;-><init>(Lcom/android/quickstep/views/LauncherRecentsView;)V
    ...
    .line 9
    invoke-virtual {p0, p1}, Lcom/android/launcher3/uioverrides/RecentsViewStateController;->isSplitSelectionState(Lcom/android/launcher3/LauncherState;)Z

    move-result v1

    if-eqz v1, :cond_1

    invoke-virtual {p0, v0}, Lcom/android/launcher3/uioverrides/RecentsViewStateController;->isSplitSelectionState(Lcom/android/launcher3/LauncherState;)Z
    ...
    invoke-virtual {v0}, Lcom/android/quickstep/views/RecentsView;->createSplitSelectInitAnimation()Lcom/android/launcher3/anim/PendingAnimation;
    ...
    invoke-virtual {v0, v1}, Lcom/android/quickstep/views/RecentsView;->cancelSplitSelect(Z)Lcom/android/launcher3/anim/PendingAnimation;
