...
.method public constructor <init>(Landroid/content/Context;Ljava/util/function/ObjIntConsumer;)V
    ...
    invoke-direct {v1, p0}, LE0/c;-><init>(Lcom/android/launcher3/model/AppEventProducer;)V
...
.method public consume(Lcom/android/launcher3/logging/StatsLogManager$EventEnum;Lcom/android/launcher3/logger/LauncherAtom$ItemInfo;)V
    ...
    .line 3
    invoke-virtual {p0, p2, p1, v1}, Lcom/android/launcher3/model/AppEventProducer;->sendEvent(Lcom/android/launcher3/logger/LauncherAtom$ItemInfo;II)V
    ...
    .line 8
    :cond_3
    invoke-static {p2}, Lcom/android/launcher3/model/AppEventProducer;->isTrackedForHotseatPrediction(Lcom/android/launcher3/logger/LauncherAtom$ItemInfo;)Z
    ...
    .line 9
    invoke-virtual {p0, p2, v2, v3}, Lcom/android/launcher3/model/AppEventProducer;->sendEvent(Lcom/android/launcher3/logger/LauncherAtom$ItemInfo;II)V

    .line 10
    :cond_4
    iget-object p1, p0, Lcom/android/launcher3/model/AppEventProducer;->mLastDragItem:Lcom/android/launcher3/logger/LauncherAtom$ItemInfo;

    invoke-static {p1}, Lcom/android/launcher3/model/AppEventProducer;->isTrackedForHotseatPrediction(Lcom/android/launcher3/logger/LauncherAtom$ItemInfo;)Z
    ...
    invoke-virtual {p0, p1, v1, v3}, Lcom/android/launcher3/model/AppEventProducer;->sendEvent(Lcom/android/launcher3/logger/LauncherAtom$ItemInfo;II)V
    ...
    invoke-virtual {p0, p1, p2, v2, v3}, Lcom/android/launcher3/model/AppEventProducer;->sendEvent(Landroid/app/prediction/AppTarget;Lcom/android/launcher3/logger/LauncherAtom$ItemInfo;II)V

    .line 16
    invoke-virtual {p0, p2, v1, v3}, Lcom/android/launcher3/model/AppEventProducer;->sendEvent(Lcom/android/launcher3/logger/LauncherAtom$ItemInfo;II)V
    ...
    invoke-virtual {p0, p1, p2, v1, v3}, Lcom/android/launcher3/model/AppEventProducer;->sendEvent(Landroid/app/prediction/AppTarget;Lcom/android/launcher3/logger/LauncherAtom$ItemInfo;II)V
...
.method public final getContainer(Lcom/android/launcher3/logger/LauncherAtom$ItemInfo;)Ljava/lang/String;
    ...
    :pswitch_4
    const-string p0, "search-results"
...
.method public final toAppTarget(Lcom/android/launcher3/logger/LauncherAtom$ItemInfo;)Landroid/app/prediction/AppTarget;
    ...
    invoke-direct {v3, v0}, LE0/d;-><init>(Landroid/os/UserHandle;)V
