...
.method public static synthetic b(Lcom/android/launcher3/DeleteDropTarget;ILcom/android/launcher3/model/ModelWriter;)V
    .locals 0

    invoke-direct {p0, p1, p2}, Lcom/android/launcher3/DeleteDropTarget;->lambda$completeDrop$0(ILcom/android/launcher3/model/ModelWriter;)V

    return-void
.end method

.method private synthetic lambda$completeDrop$0(ILcom/android/launcher3/model/ModelWriter;)V
    .locals 1

    .line 1
    iget-object v0, p0, Lcom/android/launcher3/ButtonDropTarget;->mLauncher:Lcom/android/launcher3/Launcher;

    invoke-virtual {v0, p1}, Lcom/android/launcher3/Launcher;->setPageToBindSynchronously(I)V
...
.method public completeDrop(Lcom/android/launcher3/DropTarget$DragObject;)V
    ...
    invoke-direct {v1, p0, v0, p1}, Lcom/android/launcher3/o;-><init>(Lcom/android/launcher3/DeleteDropTarget;ILcom/android/launcher3/model/ModelWriter;)V
    ...
    .line 9
    invoke-static {p0, v0, v2, v3, v1}, Lcom/android/launcher3/views/Snackbar;->show(Lcom/android/launcher3/BaseDraggingActivity;IILjava/lang/Runnable;Ljava/lang/Runnable;)V
