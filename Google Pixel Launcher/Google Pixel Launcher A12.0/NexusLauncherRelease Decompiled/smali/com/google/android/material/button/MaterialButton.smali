...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    .line 13
    invoke-static {v1, v2}, Lk2/C;->e(ILandroid/graphics/PorterDuff$Mode;)Landroid/graphics/PorterDuff$Mode;
    ...
    .line 15
    invoke-static {v1, v0, v2}, Lo2/d;->a(Landroid/content/Context;Landroid/content/res/TypedArray;I)Landroid/content/res/ColorStateList;
    ...
    invoke-static {v1, v0, v2}, Lo2/d;->d(Landroid/content/Context;Landroid/content/res/TypedArray;I)Landroid/graphics/drawable/Drawable;
    ...
    .line 19
    invoke-static {v7, p2, p3, v6}, Lr2/q;->e(Landroid/content/Context;Landroid/util/AttributeSet;II)Lr2/o;
    ...
    invoke-direct {p3, p0, p2}, LY1/d;-><init>(Lcom/google/android/material/button/MaterialButton;Lr2/q;)V

    iput-object p3, p0, Lcom/google/android/material/button/MaterialButton;->d:LY1/d;

    .line 21
    invoke-virtual {p3, v0}, LY1/d;->l(Landroid/content/res/TypedArray;)V
...
.method public C(LY1/b;)V
    ...
    .line 1
    iput-object p1, p0, Lcom/google/android/material/button/MaterialButton;->f:LY1/b;
...
.method public D(Z)V
    ...
    .line 2
    iget-object p0, p0, Lcom/google/android/material/button/MaterialButton;->d:LY1/d;

    invoke-virtual {p0, p1}, LY1/d;->q(Z)V
...
.method public final E(Z)V
    ...
    invoke-static {v1, v0}, LE/a;->p(Landroid/graphics/drawable/Drawable;Landroid/graphics/PorterDuff$Mode;)V
    ...
    .line 10
    :cond_4
    invoke-static {p0}, LP/p;->a(Landroid/widget/TextView;)[Landroid/graphics/drawable/Drawable;
...
.method public final F(II)V
    ...
    .line 9
    :cond_3
    invoke-virtual {p0}, Lcom/google/android/material/button/MaterialButton;->n()I
...
.method public b()Landroid/graphics/PorterDuff$Mode;
    ...
    invoke-virtual {p0}, LY1/d;->h()Landroid/graphics/PorterDuff$Mode;
    ...
    .line 3
    :cond_0
    invoke-super {p0}, Landroidx/appcompat/widget/z;->b()Landroid/graphics/PorterDuff$Mode;
...
.method public f(Landroid/content/res/ColorStateList;)V
    ...
    invoke-virtual {p0, p1}, LY1/d;->r(Landroid/content/res/ColorStateList;)V

    goto :goto_0

    .line 3
    :cond_0
    invoke-super {p0, p1}, Landroidx/appcompat/widget/z;->f(Landroid/content/res/ColorStateList;)V
...
.method public g(Lr2/q;)V
    ...
    invoke-virtual {p0, p1}, LY1/d;->p(Lr2/q;)V
...
.method public getBackgroundTintList()Landroid/content/res/ColorStateList;
    ...
    .line 1
    invoke-virtual {p0}, Lcom/google/android/material/button/MaterialButton;->l()Landroid/content/res/ColorStateList;
...
.method public getBackgroundTintMode()Landroid/graphics/PorterDuff$Mode;
    ...
    .line 1
    invoke-virtual {p0}, Lcom/google/android/material/button/MaterialButton;->b()Landroid/graphics/PorterDuff$Mode;
...
.method public k()Lr2/q;
    ...
    invoke-virtual {p0}, LY1/d;->e()Lr2/q;
...
.method public l()Landroid/content/res/ColorStateList;
    ...
    invoke-virtual {p0}, LY1/d;->g()Landroid/content/res/ColorStateList;
    ...
    .line 3
    :cond_0
    invoke-super {p0}, Landroidx/appcompat/widget/z;->l()Landroid/content/res/ColorStateList;
...
.method public o(Landroid/graphics/PorterDuff$Mode;)V
    ...
    invoke-virtual {p0, p1}, LY1/d;->s(Landroid/graphics/PorterDuff$Mode;)V

    goto :goto_0

    .line 3
    :cond_0
    invoke-super {p0, p1}, Landroidx/appcompat/widget/z;->o(Landroid/graphics/PorterDuff$Mode;)V
...
.method public onAttachedToWindow()V
    ...
    .line 3
    iget-object v0, p0, Lcom/google/android/material/button/MaterialButton;->d:LY1/d;

    .line 4
    invoke-virtual {v0}, LY1/d;->c()Lr2/j;
...
.method public onLayout(ZIIII)V
    ...
    .line 3
    invoke-virtual {p0, p5, p4}, LY1/d;->v(II)V
...
.method public setBackgroundColor(I)V
    ...
    invoke-virtual {p0, p1}, LY1/d;->m(I)V
...
.method public setBackgroundTintMode(Landroid/graphics/PorterDuff$Mode;)V
    ...
    .line 1
    invoke-virtual {p0, p1}, Lcom/google/android/material/button/MaterialButton;->o(Landroid/graphics/PorterDuff$Mode;)V
...
.method public setChecked(Z)V
    ...
    invoke-interface {v0, p0, v1}, LY1/a;->a(Lcom/google/android/material/button/MaterialButton;Z)V
...
.method public setPressed(Z)V
    ...
    .line 1
    iget-object v0, p0, Lcom/google/android/material/button/MaterialButton;->f:LY1/b;

    if-eqz v0, :cond_0

    .line 2
    invoke-interface {v0, p0, p1}, LY1/b;->a(Lcom/google/android/material/button/MaterialButton;Z)V
...
.method public final x()V
    ...
    invoke-static {p0, v0, v1, v1, v1}, LP/p;->h(Landroid/widget/TextView;Landroid/graphics/drawable/Drawable;Landroid/graphics/drawable/Drawable;Landroid/graphics/drawable/Drawable;Landroid/graphics/drawable/Drawable;)V
    ...
    invoke-static {p0, v1, v1, v0, v1}, LP/p;->h(Landroid/widget/TextView;Landroid/graphics/drawable/Drawable;Landroid/graphics/drawable/Drawable;Landroid/graphics/drawable/Drawable;Landroid/graphics/drawable/Drawable;)V
    ...
    invoke-static {p0, v1, v0, v1, v1}, LP/p;->h(Landroid/widget/TextView;Landroid/graphics/drawable/Drawable;Landroid/graphics/drawable/Drawable;Landroid/graphics/drawable/Drawable;Landroid/graphics/drawable/Drawable;)V
...
.method public y(Z)V
    ...
    invoke-virtual {p0, p1}, LY1/d;->o(Z)V
