...
.method public constructor <init>(Lcom/google/android/apps/nexuslauncher/NexusLauncherActivity;)V
    ...
    .line 1
    invoke-direct {p0, v0}, LA1/n;-><init>(LA1/m;)V
    ...
    iput-object v0, p0, LA1/q;->d:Landroid/graphics/PointF;

    const/4 v0, 0x0

    .line 3
    iput v0, p0, LA1/q;->e:I

    .line 4
    iput-boolean v0, p0, LA1/q;->i:Z

    .line 5
    iput-object p1, p0, LA1/q;->b:Lcom/google/android/apps/nexuslauncher/NexusLauncherActivity;
    ...
    iput p1, p0, LA1/q;->c:F

    return-void
.end method

.method public static synthetic d(LA1/q;Landroid/view/InputEvent;)V
    .locals 0

    invoke-virtual {p0, p1}, LA1/q;->e(Landroid/view/InputEvent;)V
...
.method public c(I)V
    ...
    .line 4
    :cond_2
    iget-object v0, p0, LA1/q;->g:Lcom/android/systemui/shared/system/InputChannelCompat$InputEventReceiver;
    ...
    .line 6
    iput-object v1, p0, LA1/q;->g:Lcom/android/systemui/shared/system/InputChannelCompat$InputEventReceiver;

    .line 7
    :cond_3
    iget-object v0, p0, LA1/q;->f:Lcom/android/systemui/shared/system/InputMonitorCompat;
    ...
    .line 9
    iput-object v1, p0, LA1/q;->f:Lcom/android/systemui/shared/system/InputMonitorCompat;

    .line 10
    :cond_4
    iget-object v0, p0, LA1/q;->h:Lcom/android/quickstep/util/CachedEventDispatcher;
    ...
    invoke-static {}, LA1/t;->e()Ljava/util/function/Consumer;
    ...
    .line 13
    :cond_5
    iput-object v1, p0, LA1/q;->h:Lcom/android/quickstep/util/CachedEventDispatcher;

    goto :goto_0

    .line 14
    :cond_6
    iget-object v2, p0, LA1/q;->f:Lcom/android/systemui/shared/system/InputMonitorCompat;
    ...
    .line 18
    iget-object v1, p0, LA1/q;->f:Lcom/android/systemui/shared/system/InputMonitorCompat;
    ...
    invoke-direct {v4, p0}, LA1/o;-><init>(LA1/q;)V
    ...
    iget-object v1, p0, LA1/q;->b:Lcom/google/android/apps/nexuslauncher/NexusLauncherActivity;
    ...
    iput-object v0, p0, LA1/q;->f:Lcom/android/systemui/shared/system/InputMonitorCompat;
...
.method public final e(Landroid/view/InputEvent;)V
    ...
    iget-object v2, p0, LA1/q;->b:Lcom/google/android/apps/nexuslauncher/NexusLauncherActivity;
    ...
    iget-object v1, p0, LA1/q;->d:Landroid/graphics/PointF;
    ...
    .line 15
    iget-object p1, p0, LA1/q;->f:Lcom/android/systemui/shared/system/InputMonitorCompat;

    invoke-virtual {p1}, Lcom/android/systemui/shared/system/InputMonitorCompat;->pilferPointers()V

    .line 16
    iget-object p1, p0, LA1/q;->h:Lcom/android/quickstep/util/CachedEventDispatcher;

    iget-object v0, p0, LA1/q;->b:Lcom/google/android/apps/nexuslauncher/NexusLauncherActivity;

    invoke-static {v0}, Ljava/util/Objects;->requireNonNull(Ljava/lang/Object;)Ljava/lang/Object;

    new-instance v1, LA1/p;

    invoke-direct {v1, v0}, LA1/p;-><init>(Lcom/google/android/apps/nexuslauncher/NexusLauncherActivity;)V

    invoke-virtual {p1, v1}, Lcom/android/quickstep/util/CachedEventDispatcher;->setConsumer(Ljava/util/function/Consumer;)V

    .line 17
    iget-object p0, p0, LA1/q;->b:Lcom/google/android/apps/nexuslauncher/NexusLauncherActivity;
    ...
    .line 21
    :cond_5
    iget-object p0, p0, LA1/q;->h:Lcom/android/quickstep/util/CachedEventDispatcher;
    ...
    .line 24
    :cond_7
    iget-object v0, p0, LA1/q;->d:Landroid/graphics/PointF;
