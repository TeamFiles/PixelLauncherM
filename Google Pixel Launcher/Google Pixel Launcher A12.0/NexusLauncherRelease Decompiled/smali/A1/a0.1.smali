...
.method public constructor <init>(Lcom/google/android/apps/nexuslauncher/allapps/SearchResultThumbnailView;Landroid/graphics/drawable/Icon;Ljava/lang/String;Landroid/os/UserHandle;Ljava/lang/CharSequence;Z)V
    ...
    .line 1
    iput-object p1, p0, LA1/a0;->c:Lcom/google/android/apps/nexuslauncher/allapps/SearchResultThumbnailView;

    iput-boolean p6, p0, LA1/a0;->b:Z

    invoke-direct {p0, p2, p3, p4, p5}, LA1/b0;-><init>(Landroid/graphics/drawable/Icon;Ljava/lang/String;Landroid/os/UserHandle;Ljava/lang/CharSequence;)V
...
.method public getContainerInfo()Lcom/android/launcher3/logger/LauncherAtom$ContainerInfo;
    ...
    iget-object v1, p0, LA1/a0;->c:Lcom/google/android/apps/nexuslauncher/allapps/SearchResultThumbnailView;

    .line 2
    invoke-static {v1}, Lcom/google/android/apps/nexuslauncher/allapps/SearchResultThumbnailView;->v(Lcom/google/android/apps/nexuslauncher/allapps/SearchResultThumbnailView;)Lcom/google/android/apps/nexuslauncher/NexusLauncherActivity;
    ...
    iget-boolean p0, p0, LA1/a0;->b:Z

    invoke-virtual {v1, p0}, LA1/M0;->n(Z)Lcom/android/launcher3/logger/LauncherAtomExtensions$ExtendedContainers;
