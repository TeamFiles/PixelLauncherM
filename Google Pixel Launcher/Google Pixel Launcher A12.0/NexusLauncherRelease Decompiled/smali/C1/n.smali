...
.method public static A(Ljava/lang/Integer;Ljava/util/List;I)F
    ...
    .line 6
    sget-boolean v1, LC1/n;->b:Z

    if-eqz v1, :cond_2

    .line 7
    sget-object v1, LC1/n;->a:Ljava/lang/String;
...
.method public static synthetic a(Ljava/lang/Float;)Ljava/lang/Float;
    ...
    invoke-static {p0}, LC1/n;->t(Ljava/lang/Float;)Ljava/lang/Float;
...
.method public static synthetic b(Ljava/lang/Integer;Landroid/util/Pair;)Landroid/util/Pair;
    ...
    invoke-static {p0, p1}, LC1/n;->s(Ljava/lang/Integer;Landroid/util/Pair;)Landroid/util/Pair;
...
.method public static synthetic c(Landroid/util/Pair;)Ljava/lang/Boolean;
    ...
    invoke-static {p0}, LC1/n;->v(Landroid/util/Pair;)Ljava/lang/Boolean;
...
.method private static constructPostingList(Ljava/util/List;)Ljava/util/List;
    ...
    .line 3
    :cond_0
    invoke-virtual {v2}, LC1/u;->b()Ljava/util/List;
...
.method public static synthetic d(Landroid/util/Pair;)Ljava/lang/Float;
    ...
    invoke-static {p0}, LC1/n;->x(Landroid/util/Pair;)Ljava/lang/Float;
...
.method public static synthetic e(Ljava/util/Set;Landroid/util/Pair;)Ljava/lang/Boolean;
    ...
    invoke-static {p0, p1}, LC1/n;->w(Ljava/util/Set;Landroid/util/Pair;)Ljava/lang/Boolean;
...
.method public static synthetic f(Landroid/util/Pair;)Ljava/lang/Float;
    ...
    invoke-static {p0}, LC1/n;->o(Landroid/util/Pair;)Ljava/lang/Float;
...
.method public static synthetic g(Ljava/util/Map$Entry;)Landroid/util/Pair;
    ...
    invoke-static {p0}, LC1/n;->n(Ljava/util/Map$Entry;)Landroid/util/Pair;
...
.method public static synthetic h(Landroid/util/Pair;)Z
    ...
    invoke-static {p0}, LC1/n;->q(Landroid/util/Pair;)Z
...
.method public static synthetic i(Landroid/util/Pair;)Ljava/lang/String;
    ...
    invoke-static {p0}, LC1/n;->u(Landroid/util/Pair;)Ljava/lang/String;
...
.method public static synthetic j(Ljava/lang/Integer;Landroid/util/Pair;)Landroid/util/Pair;
    ...
    invoke-static {p0, p1}, LC1/n;->p(Ljava/lang/Integer;Landroid/util/Pair;)Landroid/util/Pair;
...
.method public static synthetic k(Landroid/util/Pair;)Z
    ...
    invoke-static {p0}, LC1/n;->r(Landroid/util/Pair;)Z
...
.method public static l(Ljava/util/List;LC1/s;Lcom/android/launcher3/folder/FolderNameInfos;)Ljava/util/List;
    .locals 3
    ...
    invoke-interface {p1, v2}, LC1/s;->a(I)Ljava/lang/String;
...
.method public static synthetic p(Ljava/lang/Integer;Landroid/util/Pair;)Landroid/util/Pair;
    ...
    invoke-static {v0, p1, p0}, LC1/n;->A(Ljava/lang/Integer;Ljava/util/List;I)F
...
.method public static suggestionsComparator(Ljava/util/Set;)Ljava/util/Comparator;
    ...
    invoke-direct {v1, p0}, LC1/g;-><init>(Ljava/util/Set;)V
...
.method public static y(Ljava/util/List;ILC1/s;Ljava/util/Set;Lcom/android/launcher3/folder/FolderNameInfos;)V
    .locals 0

    .line 1
    invoke-static {p0}, LC1/n;->constructPostingList(Ljava/util/List;)Ljava/util/List;
    ...
    .line 3
    invoke-static {p0, p1}, LC1/n;->z(Ljava/util/List;Ljava/lang/Integer;)Ljava/util/List;

    move-result-object p0

    .line 4
    invoke-static {p0, p2, p4}, LC1/n;->l(Ljava/util/List;LC1/s;Lcom/android/launcher3/folder/FolderNameInfos;)Ljava/util/List;

    move-result-object p0

    .line 5
    invoke-static {p3}, LC1/n;->suggestionsComparator(Ljava/util/Set;)Ljava/util/Comparator;
    ...
    .line 6
    invoke-static {p0, p4}, LC1/n;->m(Ljava/util/List;Lcom/android/launcher3/folder/FolderNameInfos;)V
...
.method public static z(Ljava/util/List;Ljava/lang/Integer;)Ljava/util/List;
    ...
    invoke-direct {v2, p1}, LC1/f;-><init>(Ljava/lang/Integer;)V
    ...
    invoke-direct {v1, p1}, LC1/e;-><init>(Ljava/lang/Integer;)V
