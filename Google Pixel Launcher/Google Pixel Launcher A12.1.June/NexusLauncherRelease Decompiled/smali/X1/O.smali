...
.method public constructor <init>(Lcom/google/android/apps/nexuslauncher/qsb/SmartspaceViewContainer;Lcom/google/android/apps/nexuslauncher/NexusLauncherActivity;)V
    ...
    .line 1
    iput-object p1, p0, LX1/O;->c:Lcom/google/android/apps/nexuslauncher/qsb/SmartspaceViewContainer;

    iput-object p2, p0, LX1/O;->b:Lcom/google/android/apps/nexuslauncher/NexusLauncherActivity;
...
.method public static synthetic a(LX1/O;ILcom/google/android/apps/nexuslauncher/NexusLauncherActivity;)V
    .locals 0

    invoke-direct {p0, p1, p2}, LX1/O;->d(ILcom/google/android/apps/nexuslauncher/NexusLauncherActivity;)V

    return-void
.end method

.method public static synthetic b(LX1/O;Landroid/graphics/Rect;Ljava/util/concurrent/CountDownLatch;)V
    .locals 0

    invoke-direct {p0, p1, p2}, LX1/O;->c(Landroid/graphics/Rect;Ljava/util/concurrent/CountDownLatch;)V
...
.method private synthetic c(Landroid/graphics/Rect;Ljava/util/concurrent/CountDownLatch;)V
    ...
    .line 1
    iget-object p0, p0, LX1/O;->c:Lcom/google/android/apps/nexuslauncher/qsb/SmartspaceViewContainer;
...
.method public getSmartspaceState()Lcom/android/systemui/shared/system/smartspace/SmartspaceState;
    ...
    .line 3
    iget-object v2, p0, LX1/O;->c:Lcom/google/android/apps/nexuslauncher/qsb/SmartspaceViewContainer;
    ...
    invoke-direct {v3, p0, v1, v0}, LX1/N;-><init>(LX1/O;Landroid/graphics/Rect;Ljava/util/concurrent/CountDownLatch;)V
...
.method public setVisibility(I)V
    ...
    .line 1
    iget-object v0, p0, LX1/O;->c:Lcom/google/android/apps/nexuslauncher/qsb/SmartspaceViewContainer;
    ...
    iget-object v1, p0, LX1/O;->b:Lcom/google/android/apps/nexuslauncher/NexusLauncherActivity;

    new-instance v2, LX1/M;

    invoke-direct {v2, p0, p1, v1}, LX1/M;-><init>(LX1/O;ILcom/google/android/apps/nexuslauncher/NexusLauncherActivity;)V
