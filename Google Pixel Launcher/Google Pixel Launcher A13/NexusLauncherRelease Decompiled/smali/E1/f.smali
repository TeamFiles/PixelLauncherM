...
# direct methods
.method public constructor <init>(Lcom/google/android/apps/nexuslauncher/NexusLauncherActivity;LD1/F;Landroid/graphics/Rect;Landroid/graphics/Point;I)V
    .locals 2

    invoke-direct {p0, p1, p5}, Landroid/app/Dialog;-><init>(Landroid/content/Context;I)V

    iput-object p1, p0, LE1/f;->b:Lcom/google/android/apps/nexuslauncher/NexusLauncherActivity;

    iput-object p2, p0, LE1/f;->d:LD1/F;

    new-instance p2, Landroid/graphics/Rect;

    invoke-direct {p2, p3}, Landroid/graphics/Rect;-><init>(Landroid/graphics/Rect;)V

    iput-object p2, p0, LE1/f;->c:Landroid/graphics/Rect;

    new-instance p2, Landroid/graphics/Point;

    invoke-direct {p2, p4}, Landroid/graphics/Point;-><init>(Landroid/graphics/Point;)V

    iput-object p2, p0, LE1/f;->e:Landroid/graphics/Point;

    new-instance p2, Landroid/os/Handler;

    invoke-direct {p2}, Landroid/os/Handler;-><init>()V

    iput-object p2, p0, LE1/f;->f:Landroid/os/Handler;
    ...
    iput-object p2, p0, LE1/f;->i:Landroid/content/res/Configuration;
    ...
    iput-object p2, p0, LE1/f;->h:Landroid/app/Application;
    ...
    invoke-direct {p3, p0, p4}, LE1/e;-><init>(LE1/f;Landroid/content/Context;)V

    iput-object p3, p0, LE1/f;->m:LE1/e;

    new-instance p4, LE1/g;

    invoke-direct {p4, p0, p3}, LE1/g;-><init>(LE1/f;Landroid/content/Context;)V

    iput-object p4, p0, LE1/f;->n:LE1/g;
    ...
    iput-object p5, p0, LE1/f;->g:Lcom/android/launcher3/util/SystemUiController;
...
.method public static synthetic a(LE1/f;)V
    .locals 0

    invoke-direct {p0}, LE1/f;->h()V
...
.method public static synthetic b(LE1/f;)V
    ...
    invoke-virtual {p0}, LE1/f;->j()V

    return-void
.end method

.method public static bridge synthetic c(LE1/f;)LE1/g;
    .locals 0

    iget-object p0, p0, LE1/f;->n:LE1/g;

    return-object p0
.end method

.method public static bridge synthetic d(LE1/f;)Lcom/google/android/apps/nexuslauncher/NexusLauncherActivity;
    .locals 0

    iget-object p0, p0, LE1/f;->b:Lcom/google/android/apps/nexuslauncher/NexusLauncherActivity;

    return-object p0
.end method

.method public static f(Lcom/google/android/apps/nexuslauncher/NexusLauncherActivity;LD1/F;Landroid/content/Intent;)LE1/f;
    .locals 8
    ...
    invoke-direct/range {v2 .. v7}, LE1/f;-><init>(Lcom/google/android/apps/nexuslauncher/NexusLauncherActivity;LD1/F;Landroid/graphics/Rect;Landroid/graphics/Point;I)V
...
.method private synthetic h()V
    ...
    iget-object v0, p0, LE1/f;->n:LE1/g;
...
.method public e()V
    ...
    iget-object v0, p0, LE1/f;->f:Landroid/os/Handler;

    new-instance v1, LE1/c;

    invoke-direct {v1, p0}, LE1/c;-><init>(LE1/f;)V
...
.method public g()Lcom/android/launcher3/util/SystemUiController;
    ...
    iget-object p0, p0, LE1/f;->g:Lcom/android/launcher3/util/SystemUiController;
...
.method public final i(Landroid/app/Activity;)V
    ...
    iget-object v0, p0, LE1/f;->b:Lcom/google/android/apps/nexuslauncher/NexusLauncherActivity;
...
.method public final j()V
    ...
    iput-boolean v0, p0, LE1/f;->o:Z

    new-instance v1, Landroid/graphics/Rect;

    iget-object v2, p0, LE1/f;->c:Landroid/graphics/Rect;

    invoke-direct {v1, v2}, Landroid/graphics/Rect;-><init>(Landroid/graphics/Rect;)V

    iget-object v2, p0, LE1/f;->e:Landroid/graphics/Point;
    ...
    iget-object v3, p0, LE1/f;->n:LE1/g;
    ...
    iget-object v0, p0, LE1/f;->d:LD1/F;

    invoke-virtual {v0}, LD1/F;->i()Landroid/content/pm/LauncherActivityInfo;
    ...
    iget-object v3, p0, LE1/f;->b:Lcom/google/android/apps/nexuslauncher/NexusLauncherActivity;
    ...
    iget-object v2, p0, LE1/f;->b:Lcom/google/android/apps/nexuslauncher/NexusLauncherActivity;

    iget-object v3, p0, LE1/f;->n:LE1/g;

    invoke-static {v0, v3, p0, v1}, Lcom/google/android/apps/nexuslauncher/qsb/longpopup/SearchOptionsPopup;->q(Lcom/android/launcher3/BubbleTextView;LE1/g;LE1/f;Landroid/graphics/Rect;)Lcom/google/android/apps/nexuslauncher/qsb/longpopup/SearchOptionsPopup;

    move-result-object p0

    invoke-virtual {v2, p0}, Lcom/google/android/apps/nexuslauncher/NexusLauncherActivity;->Q(Lcom/google/android/apps/nexuslauncher/qsb/longpopup/SearchOptionsPopup;)V
...
.method public k(Lcom/android/launcher3/dragndrop/BaseItemDragListener;Landroid/view/View;)V
    ...
    invoke-virtual {v0, v1}, LD1/n;->e(Z)V
    ...
    invoke-direct {p1, p0, p2}, LE1/d;-><init>(LE1/f;Landroid/view/View;)V
...
.method public onActivityDestroyed(Landroid/app/Activity;)V
    ...
    invoke-virtual {p0, p1}, LE1/f;->i(Landroid/app/Activity;)V
...
.method public onConfigurationChanged(Landroid/content/res/Configuration;)V
    ...
    iget-object v0, p0, LE1/f;->i:Landroid/content/res/Configuration;
...
.method public onDismiss(Landroid/content/DialogInterface;)V
    ...
    iget-object p1, p0, LE1/f;->b:Lcom/google/android/apps/nexuslauncher/NexusLauncherActivity;

    const/4 v0, 0x0

    invoke-virtual {p1, v0}, Lcom/google/android/apps/nexuslauncher/NexusLauncherActivity;->Q(Lcom/google/android/apps/nexuslauncher/qsb/longpopup/SearchOptionsPopup;)V

    iget-object p1, p0, LE1/f;->h:Landroid/app/Application;
    ...
    iget-object p1, p0, LE1/f;->j:Lcom/android/launcher3/dragndrop/DragController;
...
.method public onDrag(Landroid/view/View;Landroid/view/DragEvent;)Z
    ...
    iget-object p1, p0, LE1/f;->d:LD1/F;

    iget-object v1, p0, LE1/f;->b:Lcom/google/android/apps/nexuslauncher/NexusLauncherActivity;

    invoke-virtual {p1, v1, p2, p0}, LD1/F;->j(Lcom/android/launcher3/Launcher;Landroid/view/DragEvent;Lcom/android/launcher3/dragndrop/DragOptions$PreDragCondition;)Z
    ...
    :cond_1
    iget-object p0, p0, LE1/f;->j:Lcom/android/launcher3/dragndrop/DragController;
...
.method public onDraw()V
    ...
    invoke-direct {v1, p0}, LE1/b;-><init>(LE1/f;)V
...
.method public onPreDragEnd(Lcom/android/launcher3/DropTarget$DragObject;Z)V
    ...
    iput-boolean p1, p0, LE1/f;->o:Z

    iget-object p2, p0, LE1/f;->b:Lcom/google/android/apps/nexuslauncher/NexusLauncherActivity;
    ...
    iget-object p2, p0, LE1/f;->g:Lcom/android/launcher3/util/SystemUiController;
    ...
    invoke-virtual {p2}, Lcom/google/android/apps/nexuslauncher/NexusLauncherActivity;->L()LD1/n;

    move-result-object p2

    invoke-virtual {p2, p1}, LD1/n;->e(Z)V
