...
.method public constructor <init>(Landroid/content/Context;Z)V
    ...
    iput-object p2, p0, Ld0/c;->d:Landroid/widget/LinearLayout;
...
.method public final a(Landroidx/core/graphics/drawable/IconCompat;Z)Landroid/widget/ImageView;
    ...
    invoke-virtual {p1, v1}, Landroidx/core/graphics/drawable/IconCompat;->q(Landroid/content/Context;)Landroid/graphics/drawable/Drawable;
    ...
    invoke-static {v0, p1}, Landroidx/core/widget/k;->c(Landroid/widget/ImageView;Landroid/content/res/ColorStateList;)V
    ...
    invoke-static {p1, v1}, Ld0/V;->e(Landroid/content/Context;I)Landroid/graphics/drawable/Drawable;
    ...
    invoke-virtual {p0, v0}, Ld0/c;->b(Landroid/view/View;)V
...
.method public final b(Landroid/view/View;)V
    ...
    iget-object v0, p0, Ld0/c;->d:Landroid/widget/LinearLayout;
...
.method public e(Landroid/view/View;Landroidx/slice/SliceItem;Landroid/app/RemoteInput;)Z
    ...
    invoke-virtual {p0, v2}, Ld0/c;->d(Landroid/view/View;)Landroidx/slice/widget/RemoteInputView;
...
.method public final f(Landroidx/slice/SliceItem;Landroidx/slice/SliceItem;Landroidx/slice/SliceItem;)V
    ...
    invoke-virtual {p0, p2, v0}, Ld0/c;->a(Landroidx/core/graphics/drawable/IconCompat;Z)Landroid/widget/ImageView;

    move-result-object p2

    new-instance v0, Ld0/b;

    invoke-direct {v0, p0, p3, p1}, Ld0/b;-><init>(Ld0/c;Landroidx/slice/SliceItem;Landroidx/slice/SliceItem;)V
    ...
    invoke-virtual {p0, p1, p2}, Ld0/c;->c(ILandroid/content/Context;)V
...
.method public g(Ljava/util/List;I)V
    ...
    invoke-virtual {p0, p2}, Ld0/c;->h(I)V
    ...
    iget-object v1, p0, Ld0/c;->d:Landroid/widget/LinearLayout;
    ...
    check-cast v1, Landroidx/slice/core/b;

    invoke-virtual {v1}, Landroidx/slice/core/b;->f()Landroidx/slice/SliceItem;

    move-result-object v2

    invoke-virtual {v1}, Landroidx/slice/core/b;->d()Landroidx/slice/SliceItem;

    move-result-object v1

    const-string v3, "input"

    invoke-static {v2, v3}, Lb0/k;->f(Landroidx/slice/SliceItem;Ljava/lang/String;)Landroidx/slice/SliceItem;

    move-result-object v3

    const-string v4, "image"

    invoke-static {v2, v4}, Lb0/k;->f(Landroidx/slice/SliceItem;Ljava/lang/String;)Landroidx/slice/SliceItem;
    ...
    invoke-virtual {p0, v3, v2, v1}, Ld0/c;->f(Landroidx/slice/SliceItem;Landroidx/slice/SliceItem;Landroidx/slice/SliceItem;)V

    goto :goto_0

    :cond_3
    invoke-interface {p2}, Lb0/d;->getIcon()Landroidx/core/graphics/drawable/IconCompat;
    ...
    :cond_4
    invoke-virtual {p0, v2, v0}, Ld0/c;->a(Landroidx/core/graphics/drawable/IconCompat;Z)Landroid/widget/ImageView;

    move-result-object p2

    new-instance v0, Ld0/a;

    invoke-direct {v0, p0, v1}, Ld0/a;-><init>(Ld0/c;Landroidx/slice/SliceItem;)V
...
.method public final h(I)V
    ...
    iget v2, p0, Ld0/c;->e:I

    invoke-static {v2}, Landroid/content/res/ColorStateList;->valueOf(I)Landroid/content/res/ColorStateList;

    move-result-object v2

    invoke-static {v1, v2}, Landroidx/core/widget/k;->c(Landroid/widget/ImageView;Landroid/content/res/ColorStateList;)V
