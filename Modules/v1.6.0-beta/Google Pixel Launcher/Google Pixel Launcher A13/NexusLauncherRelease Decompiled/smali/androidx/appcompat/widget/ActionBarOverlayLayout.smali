...
.field public v:LL/s0;

.field public w:LL/s0;

.field public x:LL/s0;

.field public y:LL/s0;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    .line 11
    sget-object p2, LL/s0;->b:LL/s0;

    iput-object p2, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->v:LL/s0;

    .line 12
    iput-object p2, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->w:LL/s0;

    .line 13
    iput-object p2, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->x:LL/s0;

    .line 14
    iput-object p2, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->y:LL/s0;
    ...
    invoke-direct {p1, p0}, LL/v;-><init>(Landroid/view/ViewGroup;)V

    iput-object p1, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->F:LL/v;
...
.method public a(Landroid/view/Menu;Lj/D;)V
    ...
    iget-object p0, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->f:Landroidx/appcompat/widget/q0;

    invoke-interface {p0, p1, p2}, Landroidx/appcompat/widget/q0;->a(Landroid/view/Menu;Lj/D;)V
...
.method public b(I)V
    ...
    invoke-interface {p0}, Landroidx/appcompat/widget/q0;->initIndeterminateProgress()V
    ...
    invoke-interface {p0}, Landroidx/appcompat/widget/q0;->initProgress()V
...
.method public c()V
    ...
    invoke-interface {p0}, Landroidx/appcompat/widget/q0;->dismissPopupMenus()V
...
.method public canShowOverflowMenu()Z
    ...
    invoke-interface {p0}, Landroidx/appcompat/widget/q0;->canShowOverflowMenu()Z
...
.method public bridge synthetic generateDefaultLayoutParams()Landroid/view/ViewGroup$LayoutParams;
    ...
    invoke-virtual {p0}, Landroidx/appcompat/widget/ActionBarOverlayLayout;->l()Landroidx/appcompat/widget/i;
...
.method public bridge synthetic generateLayoutParams(Landroid/util/AttributeSet;)Landroid/view/ViewGroup$LayoutParams;
    ...
    .line 1
    invoke-virtual {p0, p1}, Landroidx/appcompat/widget/ActionBarOverlayLayout;->m(Landroid/util/AttributeSet;)Landroidx/appcompat/widget/i;
...
.method public getNestedScrollAxes()I
    ...
    iget-object p0, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->F:LL/v;
...
.method public hideOverflowMenu()Z
    ...
    invoke-interface {p0}, Landroidx/appcompat/widget/q0;->hideOverflowMenu()Z
...
.method public isOverflowMenuShowPending()Z
    ...
    invoke-interface {p0}, Landroidx/appcompat/widget/q0;->isOverflowMenuShowPending()Z
...
.method public isOverflowMenuShowing()Z
    ...
    invoke-interface {p0}, Landroidx/appcompat/widget/q0;->isOverflowMenuShowing()Z
...
.method public l()Landroidx/appcompat/widget/i;
    .locals 1
...
.method public m(Landroid/util/AttributeSet;)Landroidx/appcompat/widget/i;
    .locals 1
...
.method public final o(Landroid/view/View;)Landroidx/appcompat/widget/q0;
    .locals 2
...
.method public onApplyWindowInsets(Landroid/view/WindowInsets;)Landroid/view/WindowInsets;
    ...
    invoke-static {p0, p1, v1}, LL/U;->e(Landroid/view/View;LL/s0;Landroid/graphics/Rect;)LL/s0;
    ...
    invoke-virtual {p1, v2, v3, v4, v1}, LL/s0;->l(IIII)LL/s0;

    move-result-object v1

    iput-object v1, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->v:LL/s0;

    iget-object v2, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->w:LL/s0;

    invoke-virtual {v2, v1}, LL/s0;->equals(Ljava/lang/Object;)Z
    ...
    iget-object v0, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->v:LL/s0;

    iput-object v0, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->w:LL/s0;
    ...
    :cond_2
    invoke-virtual {p1}, LL/s0;->a()LL/s0;

    move-result-object p0

    invoke-virtual {p0}, LL/s0;->c()LL/s0;

    move-result-object p0

    invoke-virtual {p0}, LL/s0;->b()LL/s0;
...
.method public onMeasure(II)V
    ...
    invoke-static {p0}, LL/U;->G(Landroid/view/View;)I
    ...
    iget-object v6, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->v:LL/s0;

    iput-object v6, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->x:LL/s0;
    ...
    invoke-virtual {v6, v2, v5, v2, v2}, LL/s0;->l(IIII)LL/s0;

    move-result-object v2

    iput-object v2, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->x:LL/s0;
    ...
    iget-object v6, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->x:LL/s0;

    invoke-virtual {v6}, LL/s0;->k()I

    move-result v6

    add-int/2addr v6, v5

    iget-object v5, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->x:LL/s0;

    invoke-virtual {v5}, LL/s0;->j()I

    move-result v5

    iget-object v7, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->x:LL/s0;

    invoke-virtual {v7}, LL/s0;->h()I

    move-result v7

    add-int/2addr v7, v2

    invoke-static {v4, v6, v5, v7}, LD/b;->b(IIII)LD/b;

    move-result-object v2

    new-instance v4, LL/g0;

    iget-object v5, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->x:LL/s0;

    invoke-direct {v4, v5}, LL/g0;-><init>(LL/s0;)V

    invoke-virtual {v4, v2}, LL/g0;->c(LD/b;)LL/g0;

    move-result-object v2

    invoke-virtual {v2}, LL/g0;->a()LL/s0;
    ...
    iget-object v2, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->y:LL/s0;

    iget-object v4, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->x:LL/s0;

    invoke-virtual {v2, v4}, LL/s0;->equals(Ljava/lang/Object;)Z

    move-result v2

    if-nez v2, :cond_5

    iget-object v2, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->x:LL/s0;

    iput-object v2, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->y:LL/s0;

    iget-object v4, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->d:Landroidx/appcompat/widget/ContentFrameLayout;

    invoke-static {v4, v2}, LL/U;->f(Landroid/view/View;LL/s0;)LL/s0;
...
.method public onNestedScrollAccepted(Landroid/view/View;Landroid/view/View;I)V
    ...
    iget-object v0, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->F:LL/v;

    invoke-virtual {v0, p1, p2, p3}, LL/v;->b(Landroid/view/View;Landroid/view/View;I)V

    invoke-virtual {p0}, Landroidx/appcompat/widget/ActionBarOverlayLayout;->n()I
    ...
    invoke-interface {p0}, Landroidx/appcompat/widget/h;->e()V
...
.method public onWindowSystemUiVisibilityChanged(I)V
    ...
    invoke-interface {p1, v3}, Landroidx/appcompat/widget/h;->c(Z)V
...
.method public setMenuPrepared()V
    ...
    invoke-interface {p0}, Landroidx/appcompat/widget/q0;->setMenuPrepared()V
...
.method public setWindowCallback(Landroid/view/Window$Callback;)V
    ...
    invoke-interface {p0, p1}, Landroidx/appcompat/widget/q0;->setWindowCallback(Landroid/view/Window$Callback;)V
...
.method public showOverflowMenu()Z
    ...
    invoke-interface {p0}, Landroidx/appcompat/widget/q0;->showOverflowMenu()Z
...
.method public u()V
    ...
    invoke-virtual {p0, v0}, Landroidx/appcompat/widget/ActionBarOverlayLayout;->o(Landroid/view/View;)Landroidx/appcompat/widget/q0;

    move-result-object v0

    iput-object v0, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->f:Landroidx/appcompat/widget/q0;
...
.method public x(Landroidx/appcompat/widget/h;)V
    .locals 1
