...
.method public d(LL/V;LL/V;)Lk/m;
    .locals 2
    ...
    .line 2
    invoke-virtual {p1}, LL/V;->c()J

    move-result-wide v0

    invoke-virtual {p2, v0, v1}, LL/V;->h(J)LL/V;
...
.method public h()V
    ...
    .line 4
    invoke-virtual {v1, v2, v3}, LL/V;->d(J)LL/V;
    ...
    .line 6
    invoke-virtual {v1, v2}, LL/V;->e(Landroid/view/animation/Interpolator;)LL/V;

    .line 7
    :cond_2
    iget-object v2, p0, Lk/m;->d:LL/W;

    if-eqz v2, :cond_3

    .line 8
    iget-object v2, p0, Lk/m;->f:LL/X;

    invoke-virtual {v1, v2}, LL/V;->f(LL/W;)LL/V;

    .line 9
    :cond_3
    invoke-virtual {v1}, LL/V;->j()V
