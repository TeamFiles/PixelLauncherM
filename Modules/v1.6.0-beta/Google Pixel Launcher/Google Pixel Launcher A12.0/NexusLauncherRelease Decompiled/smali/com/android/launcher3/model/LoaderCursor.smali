...
.method public checkAndAddItem(Lcom/android/launcher3/model/data/ItemInfo;Lcom/android/launcher3/model/BgDataModel;)V
    ...
    invoke-virtual {p2, p0, p1, v0}, Lcom/android/launcher3/model/BgDataModel;->addItem(Landroid/content/Context;Lcom/android/launcher3/model/data/ItemInfo;Z)V
...
.method public loadIcon(Lcom/android/launcher3/model/data/WorkspaceItemInfo;)Z
    ...
    .line 4
    iget v3, p0, Lcom/android/launcher3/model/LoaderCursor;->iconResourceIndex:I
    ...
    iput-object v4, p1, Lcom/android/launcher3/model/data/WorkspaceItemInfo;->iconResource:Landroid/content/Intent$ShortcutIconResource;

    .line 7
    iput-object v1, v4, Landroid/content/Intent$ShortcutIconResource;->packageName:Ljava/lang/String;

    .line 8
    iput-object v3, v4, Landroid/content/Intent$ShortcutIconResource;->resourceName:Ljava/lang/String;

    .line 9
    invoke-virtual {v0, v4}, Lcom/android/launcher3/icons/BaseIconFactory;->createIconBitmap(Landroid/content/Intent$ShortcutIconResource;)Lcom/android/launcher3/icons/BitmapInfo;
    ...
    :cond_1
    :try_start_1
    iget v1, p0, Lcom/android/launcher3/model/LoaderCursor;->iconIndex:I

    invoke-virtual {p0, v1}, Landroid/database/CursorWrapper;->getBlob(I)[B
    ...
    invoke-virtual {v0, p0}, Lcom/android/launcher3/icons/BaseIconFactory;->createIconBitmap(Landroid/graphics/Bitmap;)Lcom/android/launcher3/icons/BitmapInfo;
