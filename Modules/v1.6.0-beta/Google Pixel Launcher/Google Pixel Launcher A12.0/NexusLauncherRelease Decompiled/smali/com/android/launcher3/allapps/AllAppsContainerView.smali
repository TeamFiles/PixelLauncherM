...
.field public mWorkAdapterProvider:Lcom/android/launcher3/allapps/WorkAdapterProvider;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    .line 6
    invoke-interface {p2}, Lcom/android/launcher3/util/ItemInfoMatcher;->negate()Lcom/android/launcher3/util/ItemInfoMatcher;

    move-result-object p2

    iput-object p2, p0, Lcom/android/launcher3/allapps/AllAppsContainerView;->mWorkMatcher:Lcom/android/launcher3/util/ItemInfoMatcher;
    ...
    iput-object v1, p0, Lcom/android/launcher3/allapps/AllAppsContainerView;->mInsets:Landroid/graphics/Rect;
    ...
    iput-object v2, p0, Lcom/android/launcher3/allapps/AllAppsContainerView;->mSearchQueryBuilder:Landroid/text/SpannableStringBuilder;
    ...
    .line 22
    new-instance v3, Lcom/android/launcher3/allapps/WorkAdapterProvider;

    new-instance v4, Lr0/e;

    invoke-direct {v4, p0}, Lr0/e;-><init>(Lcom/android/launcher3/allapps/AllAppsContainerView;)V

    invoke-direct {v3, v1, v4}, Lcom/android/launcher3/allapps/WorkAdapterProvider;-><init>(Lcom/android/launcher3/BaseDraggingActivity;Ljava/lang/Runnable;)V

    iput-object v3, p0, Lcom/android/launcher3/allapps/AllAppsContainerView;->mWorkAdapterProvider:Lcom/android/launcher3/allapps/WorkAdapterProvider;
    ...
    invoke-direct {p1, p0}, Lr0/d;-><init>(Lcom/android/launcher3/allapps/AllAppsContainerView;)V
...
.method public static synthetic a(Lcom/android/launcher3/allapps/AllAppsContainerView;)V
    .locals 0

    invoke-direct {p0}, Lcom/android/launcher3/allapps/AllAppsContainerView;->lambda$new$0()V
...
.method public static synthetic access$200(Lcom/android/launcher3/allapps/AllAppsContainerView;)Lcom/android/launcher3/allapps/WorkAdapterProvider;
    .locals 0

    .line 1
    iget-object p0, p0, Lcom/android/launcher3/allapps/AllAppsContainerView;->mWorkAdapterProvider:Lcom/android/launcher3/allapps/WorkAdapterProvider;
...
.method public static synthetic access$600(Lcom/android/launcher3/allapps/AllAppsContainerView;)Lcom/android/launcher3/allapps/WorkModeSwitch;
    .locals 0

    .line 1
    iget-object p0, p0, Lcom/android/launcher3/allapps/AllAppsContainerView;->mWorkModeSwitch:Lcom/android/launcher3/allapps/WorkModeSwitch;
...
.method public static synthetic b(Lcom/android/launcher3/allapps/AllAppsContainerView;)V
    ...
    invoke-direct {p0}, Lcom/android/launcher3/allapps/AllAppsContainerView;->lambda$setupWorkToggle$4()V
...
.method public static synthetic d(Lcom/android/launcher3/allapps/AllAppsContainerView;Landroid/view/View;)V
    ...
    invoke-direct {p0, p1}, Lcom/android/launcher3/allapps/AllAppsContainerView;->lambda$rebindAdapters$3(Landroid/view/View;)V
...
.method public static synthetic f(Lcom/android/launcher3/allapps/AllAppsContainerView;Landroid/view/View;Z)V
    .locals 0

    invoke-direct {p0, p1, p2}, Lcom/android/launcher3/allapps/AllAppsContainerView;->lambda$onFinishInflate$1(Landroid/view/View;Z)V
...
.method private synthetic lambda$onFinishInflate$1(Landroid/view/View;Z)V
    .locals 0
...
.method private synthetic lambda$setupWorkToggle$4()V
    .locals 2
    ...
    .line 2
    invoke-virtual {p0}, Lcom/android/launcher3/allapps/AllAppsContainerView;->resetWorkProfile()V
...
.method public dispatchApplyWindowInsets(Landroid/view/WindowInsets;)Landroid/view/WindowInsets;
    ...
    iget v1, v1, Lcom/android/launcher3/DeviceProfile;->nonOverlappingTaskbarInset:I
...
.method public onActivePageChanged(I)V
    ...
    :goto_0
    invoke-virtual {v0, v3}, Lcom/android/launcher3/allapps/FloatingHeaderView;->setMainActive(Z)V
    ...
    .line 4
    :cond_1
    invoke-virtual {p0, v2}, Lcom/android/launcher3/allapps/AllAppsContainerView;->reset(Z)V

    .line 5
    iget-object v0, p0, Lcom/android/launcher3/allapps/AllAppsContainerView;->mWorkModeSwitch:Lcom/android/launcher3/allapps/WorkModeSwitch;
    ...
    .line 7
    invoke-virtual {p0, p1}, Lcom/android/launcher3/allapps/AllAppsStore;->hasModelFlag(I)Z
    ...
    .line 8
    :cond_2
    invoke-virtual {v0, v1}, Lcom/android/launcher3/allapps/WorkModeSwitch;->setWorkTabVisible(Z)V
...
.method public final onAppsUpdated()V
    ...
    .line 2
    iget-object v5, p0, Lcom/android/launcher3/allapps/AllAppsContainerView;->mWorkMatcher:Lcom/android/launcher3/util/ItemInfoMatcher;
...
.method public onFinishInflate()V
    ...
    invoke-direct {v0, p0}, Lr0/c;-><init>(Lcom/android/launcher3/allapps/AllAppsContainerView;)V
...
.method public rebindAdapters(Z)V
    ...
    invoke-direct {v0, p0}, Lr0/a;-><init>(Lcom/android/launcher3/allapps/AllAppsContainerView;)V
    ...
    invoke-direct {v0, p0}, Lr0/b;-><init>(Lcom/android/launcher3/allapps/AllAppsContainerView;)V
...
.method public final removeWorkToggle()V
    .locals 1
    ...
    .line 4
    iput-object v0, p0, Lcom/android/launcher3/allapps/AllAppsContainerView;->mWorkModeSwitch:Lcom/android/launcher3/allapps/WorkModeSwitch;
...
.method public final replaceRVContainer(Z)V
    ...
    .line 3
    invoke-virtual {v2, v4}, Landroidx/recyclerview/widget/RecyclerView;->setLayoutManager(Landroidx/recyclerview/widget/m0;)V

    .line 4
    invoke-virtual {v2, v4}, Lcom/android/launcher3/allapps/AllAppsRecyclerView;->setAdapter(Landroidx/recyclerview/widget/X;)V
    ...
    .line 8
    sget v1, Lcom/android/launcher3/R$layout;->all_apps_tabs:I

    goto :goto_1

    :cond_2
    sget v1, Lcom/android/launcher3/R$layout;->all_apps_rv_layout:I
    ...
    const-string v2, "should show tabs:"
    ...
    .line 16
    invoke-virtual {p0}, Lcom/android/launcher3/allapps/AllAppsContainerView;->setupWorkToggle()V
    ...
    .line 18
    invoke-virtual {p0}, Lcom/android/launcher3/allapps/AllAppsContainerView;->removeWorkToggle()V
...
.method public final resetWorkProfile()V
    .locals 2
    ...
    .line 2
    iget-object v1, p0, Lcom/android/launcher3/allapps/AllAppsContainerView;->mWorkModeSwitch:Lcom/android/launcher3/allapps/WorkModeSwitch;

    if-eqz v1, :cond_0

    .line 3
    invoke-virtual {v1, v0}, Lcom/android/launcher3/allapps/WorkModeSwitch;->updateCurrentState(Z)V

    .line 4
    :cond_0
    iget-object p0, p0, Lcom/android/launcher3/allapps/AllAppsContainerView;->mWorkAdapterProvider:Lcom/android/launcher3/allapps/WorkAdapterProvider;

    invoke-virtual {p0, v0}, Lcom/android/launcher3/allapps/WorkAdapterProvider;->updateCurrentState(Z)V
...
.method public setInsets(Landroid/graphics/Rect;)V
    ...
    iget-object v6, v6, Lcom/android/launcher3/allapps/AllAppsContainerView$AdapterHolder;->padding:Landroid/graphics/Rect;
...
.method public setupHeader()V
    ...
    iput v0, p0, Lcom/android/launcher3/allapps/AllAppsContainerView;->mHeaderTop:F

    return-void
.end method

.method public final setupWorkToggle()V
    .locals 3
    ...
    sget v1, Lcom/android/launcher3/R$layout;->work_mode_fab:I
    ...
    iget-object v1, p0, Lcom/android/launcher3/allapps/AllAppsContainerView;->mInsets:Landroid/graphics/Rect;

    invoke-virtual {v0, v1}, Lcom/android/launcher3/allapps/WorkModeSwitch;->setInsets(Landroid/graphics/Rect;)V
    ...
    invoke-direct {v1, p0}, Lr0/f;-><init>(Lcom/android/launcher3/allapps/AllAppsContainerView;)V
...
.method public updateHeaderScroll(I)V
    ...
    invoke-static {v4, v5, v1}, LD/a;->g(IIF)I
    ...
    .line 4
    invoke-static {v4, v5}, LD/a;->r(II)I
    ...
    .line 13
    invoke-virtual {v2}, Lcom/android/launcher3/ExtendedEditText;->getBackgroundVisibility()Z
    ...
    .line 15
    :cond_3
    iget p0, p0, Lcom/android/launcher3/allapps/AllAppsContainerView;->mHeaderThreshold:F
    ...
    .line 16
    invoke-virtual {v2, v7, v3}, Lcom/android/launcher3/ExtendedEditText;->setBackgroundVisibility(ZF)V
