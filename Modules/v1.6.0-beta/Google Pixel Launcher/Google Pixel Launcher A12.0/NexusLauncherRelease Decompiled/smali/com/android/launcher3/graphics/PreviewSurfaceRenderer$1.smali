...
.method public static synthetic b(Lcom/android/launcher3/graphics/PreviewSurfaceRenderer$1;Lcom/android/launcher3/graphics/LauncherPreviewRenderer$PreviewContext;)V
    .locals 0
...
.method private synthetic lambda$run$0(Lcom/android/launcher3/graphics/LauncherPreviewRenderer$PreviewContext;)V
    ...
    invoke-static {v0, p1, v1, v2}, Lcom/android/launcher3/graphics/PreviewSurfaceRenderer;->access$000(Lcom/android/launcher3/graphics/PreviewSurfaceRenderer;Landroid/content/Context;Lcom/android/launcher3/model/BgDataModel;Ljava/util/Map;)V
    ...
    invoke-direct {v0, p1}, Ly0/l;-><init>(Lcom/android/launcher3/graphics/LauncherPreviewRenderer$PreviewContext;)V
...
.method public run()V
    ...
    sget-object v1, Lcom/android/launcher3/LauncherSettings$Favorites;->PREVIEW_CONTENT_URI:Landroid/net/Uri;

    const-string v2, "screen = 0 or container = -101"

    invoke-virtual {p0, v0, v1, v2}, Lcom/android/launcher3/model/LoaderTask;->loadWorkspace(Ljava/util/List;Landroid/net/Uri;Ljava/lang/String;)V
    ...
    invoke-direct {v2, p0, v1}, Ly0/m;-><init>(Lcom/android/launcher3/graphics/PreviewSurfaceRenderer$1;Lcom/android/launcher3/graphics/LauncherPreviewRenderer$PreviewContext;)V
