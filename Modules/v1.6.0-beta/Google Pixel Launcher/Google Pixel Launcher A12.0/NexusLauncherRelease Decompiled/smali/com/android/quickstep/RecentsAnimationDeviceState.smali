...
.method public constructor <init>(Landroid/content/Context;Z)V
    ...
    iput-object v2, p0, Lcom/android/quickstep/RecentsAnimationDeviceState;->mSysUiNavMode:Lcom/android/quickstep/SysUINavigationMode;
    ...
    iget v1, v1, Lcom/android/launcher3/util/DisplayController$Info;->id:I
    ...
    invoke-direct {v3, p0}, Lf1/k1;-><init>(Lcom/android/quickstep/RecentsAnimationDeviceState;)V
    ...
    invoke-direct {p2, v3}, Lf1/c1;-><init>(Lcom/android/quickstep/RotationTouchHelper;)V
    ...
    .line 20
    :cond_1
    new-instance p2, Lf1/l1;

    invoke-direct {p2, p0}, Lf1/l1;-><init>(Lcom/android/quickstep/RecentsAnimationDeviceState;)V
    ...
    invoke-direct {v0, p2}, Lf1/d1;-><init>(Lcom/android/systemui/shared/system/SystemGestureExclusionListenerCompat;)V
    ...
    invoke-direct {p2, p0}, Lf1/n1;-><init>(Lcom/android/quickstep/RecentsAnimationDeviceState;)V
    ...
    .line 29
    iget-object v2, p0, Lcom/android/quickstep/RecentsAnimationDeviceState;->mGestureBlockedActivities:Ljava/util/List;
    ...
    invoke-direct {v0, p0}, Lf1/g1;-><init>(Lcom/android/quickstep/RecentsAnimationDeviceState;)V
    ...
    invoke-direct {v1, p1, p2, v0}, Lf1/j1;-><init>(Lcom/android/launcher3/util/SettingsCache;Landroid/net/Uri;Lcom/android/launcher3/util/SettingsCache$OnChangeListener;)V
    ...
    invoke-direct {v0, p0}, Lf1/Z0;-><init>(Lcom/android/quickstep/RecentsAnimationDeviceState;)V
    ...
    invoke-direct {v1, p1, p2, v0}, Lf1/h1;-><init>(Lcom/android/launcher3/util/SettingsCache;Landroid/net/Uri;Lcom/android/launcher3/util/SettingsCache$OnChangeListener;)V
    ...
    .line 46
    invoke-virtual {p1, p2, v4}, Lcom/android/launcher3/util/SettingsCache;->getValue(Landroid/net/Uri;I)Z
    ...
    invoke-direct {v0, p0}, Lf1/f1;-><init>(Lcom/android/quickstep/RecentsAnimationDeviceState;)V
    ...
    invoke-direct {v1, p1, p2, v0}, Lf1/i1;-><init>(Lcom/android/launcher3/util/SettingsCache;Landroid/net/Uri;Lcom/android/launcher3/util/SettingsCache$OnChangeListener;)V
    ...
    invoke-interface {p1, p2, v4}, Landroid/app/IActivityTaskManager;->getRootTaskInfo(II)Landroid/app/ActivityTaskManager$RootTaskInfo;
    ...
    :cond_6
    iput-boolean v4, p0, Lcom/android/quickstep/RecentsAnimationDeviceState;->mPipIsActive:Z
    :try_end_1
    ...
    invoke-direct {p1, p0}, Lf1/m1;-><init>(Lcom/android/quickstep/RecentsAnimationDeviceState;)V
...
.method public addNavigationModeChangedCallback(Lcom/android/quickstep/SysUINavigationMode$NavigationModeChangeListener;)V
    ...
    invoke-direct {v0, p0, p1}, Lf1/a1;-><init>(Lcom/android/quickstep/RecentsAnimationDeviceState;Lcom/android/quickstep/SysUINavigationMode$NavigationModeChangeListener;)V
...
.method public addOneHandedModeChangedCallback(Lcom/android/quickstep/SysUINavigationMode$OneHandedModeChangeListener;)V
    ...
    invoke-direct {v0, p0, p1}, Lf1/b1;-><init>(Lcom/android/quickstep/RecentsAnimationDeviceState;Lcom/android/quickstep/SysUINavigationMode$OneHandedModeChangeListener;)V
...
.method public getGestureBlockedActivityPackages()Ljava/util/List;
    ...
    sget-object v0, Lf1/e1;->a:Lf1/e1;
