...
.method public constructor <init>(Lcom/android/quickstep/FallbackSwipeHandler;J)V
    ...
    .line 12
    iget-object p2, p1, Lcom/android/quickstep/SwipeUpAnimationLogic;->mTransformParams:Lcom/android/quickstep/util/TransformParams;

    new-instance p3, Lf1/e0;

    invoke-direct {p3, p0}, Lf1/e0;-><init>(Lcom/android/quickstep/FallbackSwipeHandler$FallbackHomeAnimationFactory;)V

    invoke-virtual {p2, p3}, Lcom/android/quickstep/util/TransformParams;->setHomeBuilderProxy(Lcom/android/quickstep/util/TransformParams$BuilderProxy;)Lcom/android/quickstep/util/TransformParams;
    ...
    invoke-direct {v1, p0}, Lf1/g0;-><init>(Lcom/android/quickstep/FallbackSwipeHandler$FallbackHomeAnimationFactory;)V
    ...
    invoke-direct {p2, p0}, Lf1/e0;-><init>(Lcom/android/quickstep/FallbackSwipeHandler$FallbackHomeAnimationFactory;)V
    ...
    .line 17
    iget-object p1, p1, Lcom/android/quickstep/SwipeUpAnimationLogic;->mTransformParams:Lcom/android/quickstep/util/TransformParams;

    new-instance p2, Lf1/f0;

    invoke-direct {p2, p0}, Lf1/f0;-><init>(Lcom/android/quickstep/FallbackSwipeHandler$FallbackHomeAnimationFactory;)V

    invoke-virtual {p1, p2}, Lcom/android/quickstep/util/TransformParams;->setBaseBuilderProxy(Lcom/android/quickstep/util/TransformParams$BuilderProxy;)Lcom/android/quickstep/util/TransformParams;
...
.method private addGestureContract(Landroid/content/Intent;)V
    ...
    invoke-direct {v2, p0}, Lf1/h0;-><init>(Lcom/android/quickstep/FallbackSwipeHandler$FallbackHomeAnimationFactory;)V
...
.method public static synthetic c(Lcom/android/quickstep/FallbackSwipeHandler$FallbackHomeAnimationFactory;Lcom/android/systemui/shared/system/SyncRtSurfaceTransactionApplierCompat$SurfaceParams$Builder;Lcom/android/systemui/shared/system/RemoteAnimationTargetCompat;Lcom/android/quickstep/util/TransformParams;)V
    .locals 0
...
.method public handleHomeTaskAppeared(Lcom/android/systemui/shared/system/RemoteAnimationTargetCompat;)Z
    ...
    new-array v4, v1, [Lcom/android/systemui/shared/system/RemoteAnimationTargetCompat;
    ...
    invoke-direct {v0, v3, v4, v1, p1}, Lcom/android/quickstep/RemoteAnimationTargets;-><init>([Lcom/android/systemui/shared/system/RemoteAnimationTargetCompat;[Lcom/android/systemui/shared/system/RemoteAnimationTargetCompat;[Lcom/android/systemui/shared/system/RemoteAnimationTargetCompat;I)V
    ...
    invoke-virtual {p1, v0}, Lcom/android/quickstep/util/TransformParams;->setTargetSet(Lcom/android/quickstep/RemoteAnimationTargets;)Lcom/android/quickstep/util/TransformParams;
...
.method public update(Lcom/android/quickstep/util/AppCloseConfig;Landroid/graphics/RectF;FF)V
    ...
    .line 1
    iget-object p1, p0, Lcom/android/quickstep/FallbackSwipeHandler$FallbackHomeAnimationFactory;->mSurfaceControl:Landroid/view/SurfaceControl;

    if-eqz p1, :cond_0

    .line 2
    iget-object p1, p0, Lcom/android/quickstep/FallbackSwipeHandler$FallbackHomeAnimationFactory;->mTempRect:Landroid/graphics/Rect;
    ...
    invoke-virtual {p1, p2, p3, p0, p4}, Landroid/view/SurfaceControl$Transaction;->setGeometry(Landroid/view/SurfaceControl;Landroid/graphics/Rect;Landroid/graphics/Rect;I)Landroid/view/SurfaceControl$Transaction;
