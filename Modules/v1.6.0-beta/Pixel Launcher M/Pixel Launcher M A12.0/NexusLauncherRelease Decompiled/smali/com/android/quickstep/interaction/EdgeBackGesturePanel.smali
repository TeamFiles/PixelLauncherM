...
.field private static final CURRENT_ANGLE:LU/E;

.field private static final CURRENT_TRANSLATION:LU/E;

.field private static final CURRENT_VERTICAL_TRANSLATION:LU/E;
...
# instance fields
.field private final mAngleAnimation:LU/F;

.field private final mAngleAppearForce:LU/G;

.field private final mAngleDisappearForce:LU/G;
...
.field private final mRegularTranslationSpring:LU/G;

.field private mScreenSize:I

.field private final mSetGoneEndListener:LU/x;
...
.field private final mTranslationAnimation:LU/F;

.field private mTriggerBack:Z

.field private final mTriggerBackSpring:LU/G;

.field private mVelocityTracker:Landroid/view/VelocityTracker;

.field private mVerticalTranslation:F

.field private final mVerticalTranslationAnimation:LU/F;
...
.method public static constructor <clinit>()V
    ...
    sput-object v0, Lcom/android/quickstep/interaction/EdgeBackGesturePanel;->CURRENT_ANGLE:LU/E;
    ...
    sput-object v0, Lcom/android/quickstep/interaction/EdgeBackGesturePanel;->CURRENT_TRANSLATION:LU/E;
    ...
    sput-object v0, Lcom/android/quickstep/interaction/EdgeBackGesturePanel;->CURRENT_VERTICAL_TRANSLATION:LU/E;
...
.method public constructor <init>(Landroid/content/Context;Landroid/view/ViewGroup;Landroid/view/ViewGroup$LayoutParams;)V
    ...
    iput-object v1, p0, Lcom/android/quickstep/interaction/EdgeBackGesturePanel;->mSetGoneEndListener:LU/x;
    ...
    invoke-direct {v2, p0}, Li1/b;-><init>(Lcom/android/quickstep/interaction/EdgeBackGesturePanel;)V
    ...
    sget-object v2, Lcom/android/quickstep/interaction/EdgeBackGesturePanel;->CURRENT_ANGLE:LU/E;

    invoke-direct {v1, p0, v2}, LU/F;-><init>(Ljava/lang/Object;LU/E;)V

    iput-object v1, p0, Lcom/android/quickstep/interaction/EdgeBackGesturePanel;->mAngleAnimation:LU/F;
    ...
    .line 22
    invoke-virtual {v2, v3}, LU/G;->f(F)LU/G;
    ...
    .line 23
    invoke-virtual {v2, v3}, LU/G;->d(F)LU/G;

    move-result-object v2

    iput-object v2, p0, Lcom/android/quickstep/interaction/EdgeBackGesturePanel;->mAngleAppearForce:LU/G;
    ...
    .line 25
    invoke-virtual {v4, v5}, LU/G;->f(F)LU/G;

    move-result-object v4

    .line 26
    invoke-virtual {v4, v3}, LU/G;->d(F)LU/G;
    ...
    .line 27
    invoke-virtual {v3, v4}, LU/G;->e(F)LU/G;

    move-result-object v3

    iput-object v3, p0, Lcom/android/quickstep/interaction/EdgeBackGesturePanel;->mAngleDisappearForce:LU/G;

    .line 28
    invoke-virtual {v1, v2}, LU/F;->z(LU/G;)LU/F;

    move-result-object v1

    invoke-virtual {v1, v4}, LU/A;->l(F)LU/A;

    .line 29
    new-instance v1, LU/F;

    sget-object v2, Lcom/android/quickstep/interaction/EdgeBackGesturePanel;->CURRENT_TRANSLATION:LU/E;

    invoke-direct {v1, p0, v2}, LU/F;-><init>(Ljava/lang/Object;LU/E;)V

    iput-object v1, p0, Lcom/android/quickstep/interaction/EdgeBackGesturePanel;->mTranslationAnimation:LU/F;
    ...
    .line 31
    invoke-virtual {v2, v5}, LU/G;->f(F)LU/G;
    ...
    iput-object v2, p0, Lcom/android/quickstep/interaction/EdgeBackGesturePanel;->mRegularTranslationSpring:LU/G;
    ...
    .line 34
    invoke-virtual {v4, v6}, LU/G;->f(F)LU/G;
    ...
    iput-object v4, p0, Lcom/android/quickstep/interaction/EdgeBackGesturePanel;->mTriggerBackSpring:LU/G;
    ...
    sget-object v2, Lcom/android/quickstep/interaction/EdgeBackGesturePanel;->CURRENT_VERTICAL_TRANSLATION:LU/E;

    invoke-direct {v1, p0, v2}, LU/F;-><init>(Ljava/lang/Object;LU/E;)V

    iput-object v1, p0, Lcom/android/quickstep/interaction/EdgeBackGesturePanel;->mVerticalTranslationAnimation:LU/F;
    ...
    .line 43
    sget v1, Lcom/android/launcher3/R$color;->back_arrow_color_light:I

    goto :goto_0

    .line 44
    :cond_0
    sget v1, Lcom/android/launcher3/R$color;->back_arrow_color_dark:I
...
.method private cancelBack()V
    ...
    .line 3
    :cond_0
    iget-object v0, p0, Lcom/android/quickstep/interaction/EdgeBackGesturePanel;->mTranslationAnimation:LU/F;
    ...
    iget-object p0, p0, Lcom/android/quickstep/interaction/EdgeBackGesturePanel;->mSetGoneEndListener:LU/x;

    invoke-virtual {v0, p0}, LU/A;->b(LU/x;)LU/A;
...
.method private synthetic lambda$triggerBack$2()V
    ...
    .line 3
    iget-object v2, p0, Lcom/android/quickstep/interaction/EdgeBackGesturePanel;->mTranslationAnimation:LU/F;

    iget-object v3, p0, Lcom/android/quickstep/interaction/EdgeBackGesturePanel;->mTriggerBackSpring:LU/G;

    invoke-virtual {v2, v3}, LU/F;->z(LU/G;)LU/F;
    ...
    invoke-direct {v1, p0}, Li1/d;-><init>(Lcom/android/quickstep/interaction/EdgeBackGesturePanel;)V
...
.method private resetOnDown()V
    ...
    .line 2
    iget-object v0, p0, Lcom/android/quickstep/interaction/EdgeBackGesturePanel;->mAngleAnimation:LU/F;
    ...
    .line 4
    iget-object v0, p0, Lcom/android/quickstep/interaction/EdgeBackGesturePanel;->mVerticalTranslationAnimation:LU/F;
    ...
    .line 7
    iget-object v1, p0, Lcom/android/quickstep/interaction/EdgeBackGesturePanel;->mTranslationAnimation:LU/F;

    iget-object v2, p0, Lcom/android/quickstep/interaction/EdgeBackGesturePanel;->mRegularTranslationSpring:LU/G;
...
.method private setDesiredTranslation(FZ)V
    ...
    .line 4
    :cond_0
    iget-object p0, p0, Lcom/android/quickstep/interaction/EdgeBackGesturePanel;->mTranslationAnimation:LU/F;

    invoke-virtual {p0, p1}, LU/F;->v(F)V
...
.method private setDesiredVerticalTransition(FZ)V
    ...
    .line 4
    :cond_0
    iget-object p2, p0, Lcom/android/quickstep/interaction/EdgeBackGesturePanel;->mVerticalTranslationAnimation:LU/F;

    invoke-virtual {p2, p1}, LU/F;->v(F)V
...
.method private setTriggerBack(ZZ)V
    ...
    .line 3
    iget-object p1, p0, Lcom/android/quickstep/interaction/EdgeBackGesturePanel;->mAngleAnimation:LU/F;

    invoke-virtual {p1}, LU/F;->c()V
...
.method private triggerBack()V
    ...
    invoke-direct {v0, p0}, Li1/c;-><init>(Lcom/android/quickstep/interaction/EdgeBackGesturePanel;)V

    .line 13
    iget-object v1, p0, Lcom/android/quickstep/interaction/EdgeBackGesturePanel;->mTranslationAnimation:LU/F;

    invoke-virtual {v1}, LU/A;->h()Z
    ...
    invoke-virtual {v1, v2}, LU/A;->b(LU/x;)LU/A;
...
.method private updateAngle(Z)V
    ...
    iget-object v0, p0, Lcom/android/quickstep/interaction/EdgeBackGesturePanel;->mAngleAppearForce:LU/G;

    goto :goto_1

    :cond_2
    iget-object v0, p0, Lcom/android/quickstep/interaction/EdgeBackGesturePanel;->mAngleDisappearForce:LU/G;
    ...
    invoke-virtual {p1, v2}, LU/F;->v(F)V
