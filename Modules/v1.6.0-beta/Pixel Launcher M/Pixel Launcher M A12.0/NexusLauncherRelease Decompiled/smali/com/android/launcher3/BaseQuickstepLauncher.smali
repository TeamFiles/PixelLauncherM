...
.field public mSplitPlaceholderView:Lcom/android/quickstep/views/SplitPlaceholderView;
...
.field public final mTisBinderConnection:Landroid/content/ServiceConnection;
...
.method public constructor <init>()V
    ...
    .line 3
    new-instance v0, Lcom/android/launcher3/BaseQuickstepLauncher$1;

    invoke-direct {v0, p0}, Lcom/android/launcher3/BaseQuickstepLauncher$1;-><init>(Lcom/android/launcher3/BaseQuickstepLauncher;)V

    iput-object v0, p0, Lcom/android/launcher3/BaseQuickstepLauncher;->mTisBinderConnection:Landroid/content/ServiceConnection;

    .line 4
    new-instance v0, Lcom/android/launcher3/taskbar/TaskbarStateHandler;

    invoke-direct {v0, p0}, Lcom/android/launcher3/taskbar/TaskbarStateHandler;-><init>(Lcom/android/launcher3/BaseQuickstepLauncher;)V

    iput-object v0, p0, Lcom/android/launcher3/BaseQuickstepLauncher;->mTaskbarStateHandler:Lcom/android/launcher3/taskbar/TaskbarStateHandler;
...
.method public static synthetic access$000(Lcom/android/launcher3/BaseQuickstepLauncher;)Lcom/android/launcher3/taskbar/TaskbarManager;
    .locals 0

    .line 1
    iget-object p0, p0, Lcom/android/launcher3/BaseQuickstepLauncher;->mTaskbarManager:Lcom/android/launcher3/taskbar/TaskbarManager;

    return-object p0
.end method

.method public static synthetic access$002(Lcom/android/launcher3/BaseQuickstepLauncher;Lcom/android/launcher3/taskbar/TaskbarManager;)Lcom/android/launcher3/taskbar/TaskbarManager;
    .locals 0

    .line 1
    iput-object p1, p0, Lcom/android/launcher3/BaseQuickstepLauncher;->mTaskbarManager:Lcom/android/launcher3/taskbar/TaskbarManager;

    return-object p1
.end method

.method public static synthetic access$102(Lcom/android/launcher3/BaseQuickstepLauncher;Lcom/android/quickstep/OverviewCommandHelper;)Lcom/android/quickstep/OverviewCommandHelper;
    .locals 0
...
.method public static synthetic r(Landroid/content/Context;II)V
    .locals 0
...
.method public collectStateHandlers(Ljava/util/List;)V
    ...
    .line 5
    invoke-virtual {p0}, Lcom/android/launcher3/BaseQuickstepLauncher;->getTaskbarStateHandler()Lcom/android/launcher3/taskbar/TaskbarStateHandler;
...
.method public finishBindingItems(I)V
    ...
    .line 1
    invoke-super {p0, p1}, Lcom/android/launcher3/Launcher;->finishBindingItems(I)V
...
.method public getNormalTaskbarScale()F
    ...
    .line 2
    invoke-virtual {v0}, Lcom/android/launcher3/taskbar/LauncherTaskbarUIController;->getTaskbarScaleOnHome()F
    ...
    .line 3
    :cond_0
    invoke-super {p0}, Lcom/android/launcher3/Launcher;->getNormalTaskbarScale()F
...
.method public getTaskbarStateHandler()Lcom/android/launcher3/taskbar/TaskbarStateHandler;
    .locals 0

    .line 1
    iget-object p0, p0, Lcom/android/launcher3/BaseQuickstepLauncher;->mTaskbarStateHandler:Lcom/android/launcher3/taskbar/TaskbarStateHandler;
...
.method public onDestroy()V
    ...
    .line 3
    iget-object v0, p0, Lcom/android/launcher3/BaseQuickstepLauncher;->mTisBinderConnection:Landroid/content/ServiceConnection;
    ...
    .line 5
    invoke-virtual {v0, v1}, Lcom/android/launcher3/taskbar/TaskbarManager;->setLauncher(Lcom/android/launcher3/BaseQuickstepLauncher;)V
...
.method public setupViews()V
    ...
    iput-object v0, p0, Lcom/android/launcher3/BaseQuickstepLauncher;->mSplitPlaceholderView:Lcom/android/quickstep/views/SplitPlaceholderView;
    ...
    .line 6
    iget-object v1, p0, Lcom/android/launcher3/BaseQuickstepLauncher;->mSplitPlaceholderView:Lcom/android/quickstep/views/SplitPlaceholderView;
    ...
    invoke-direct {v2, v3, v4}, Lcom/android/quickstep/util/SplitSelectStateController;-><init>(Landroid/os/Handler;Lcom/android/quickstep/SystemUiProxy;)V

    .line 8
    invoke-virtual {v1, v2}, Lcom/android/quickstep/views/SplitPlaceholderView;->init(Lcom/android/quickstep/util/SplitSelectStateController;)V
    ...
    iget-object v2, p0, Lcom/android/launcher3/BaseQuickstepLauncher;->mSplitPlaceholderView:Lcom/android/quickstep/views/SplitPlaceholderView;

    invoke-virtual {v0, v1, v2}, Lcom/android/quickstep/views/RecentsView;->init(Lcom/android/quickstep/views/OverviewActionsView;Lcom/android/quickstep/views/SplitPlaceholderView;)V
    ...
    iget-object v1, p0, Lcom/android/launcher3/BaseQuickstepLauncher;->mTisBinderConnection:Landroid/content/ServiceConnection;
...
.method public useFadeOutAnimationForLauncherStart(Landroid/os/CancellationSignal;)V
    ...
    .line 2
    new-instance v1, Lcom/android/launcher3/BaseQuickstepLauncher$2;

    invoke-direct {v1, p0, p1}, Lcom/android/launcher3/BaseQuickstepLauncher$2;-><init>(Lcom/android/launcher3/BaseQuickstepLauncher;Landroid/os/CancellationSignal;)V
