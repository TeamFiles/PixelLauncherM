...
.method public static synthetic f(Lcom/google/android/apps/nexuslauncher/qsb/longpopup/SearchOptionsPopup;Landroid/view/View;)V
    .locals 0

    invoke-virtual {p0, p1}, Lcom/google/android/apps/nexuslauncher/qsb/longpopup/SearchOptionsPopup;->l(Landroid/view/View;)V

    return-void
.end method

.method public static synthetic g(Lcom/google/android/apps/nexuslauncher/qsb/longpopup/SearchOptionsPopup;)Lcom/android/launcher3/statemanager/StatefulActivity;
    .locals 0
...
.method public static synthetic h(Lcom/google/android/apps/nexuslauncher/qsb/longpopup/SearchOptionsPopup;)LI1/g;
    .locals 0

    .line 1
    iget-object p0, p0, Lcom/google/android/apps/nexuslauncher/qsb/longpopup/SearchOptionsPopup;->c:LI1/g;

    return-object p0
.end method

.method public static synthetic i(Lcom/google/android/apps/nexuslauncher/qsb/longpopup/SearchOptionsPopup;)LI1/f;
    .locals 0

    .line 1
    iget-object p0, p0, Lcom/google/android/apps/nexuslauncher/qsb/longpopup/SearchOptionsPopup;->e:LI1/f;

    return-object p0
.end method

.method public static synthetic j(Lcom/google/android/apps/nexuslauncher/qsb/longpopup/SearchOptionsPopup;)V
    .locals 0
...
.method public static m(Lcom/android/launcher3/BubbleTextView;LI1/g;LI1/f;Landroid/graphics/Rect;)Lcom/google/android/apps/nexuslauncher/qsb/longpopup/SearchOptionsPopup;
    .locals 7
    ...
    .line 8
    iput-object p1, v4, Lcom/google/android/apps/nexuslauncher/qsb/longpopup/SearchOptionsPopup;->c:LI1/g;

    .line 9
    iput-object p3, v4, Lcom/google/android/apps/nexuslauncher/qsb/longpopup/SearchOptionsPopup;->d:Landroid/graphics/Rect;

    .line 10
    iput-object p2, v4, Lcom/google/android/apps/nexuslauncher/qsb/longpopup/SearchOptionsPopup;->e:LI1/f;
    ...
    iget-object p3, v4, Lcom/android/launcher3/popup/ArrowPopup;->mLauncher:Lcom/android/launcher3/statemanager/StatefulActivity;

    invoke-direct {p2, p3, v1}, Lcom/android/launcher3/popup/SystemShortcut$AppInfo;-><init>(Lcom/android/launcher3/BaseDraggingActivity;Lcom/android/launcher3/model/data/ItemInfo;)V
    ...
    invoke-direct {p2, v4, v1}, LI1/i;-><init>(Lcom/google/android/apps/nexuslauncher/qsb/longpopup/SearchOptionsPopup;Lcom/android/launcher3/model/data/ItemInfo;)V
...
.method public getItemClickListener()Landroid/view/View$OnClickListener;
    ...
    invoke-direct {v0, p0}, LI1/h;-><init>(Lcom/google/android/apps/nexuslauncher/qsb/longpopup/SearchOptionsPopup;)V
...
.method public bridge synthetic getPopupContainer()Lcom/android/launcher3/views/BaseDragLayer;
    ...
    .line 1
    invoke-virtual {p0}, Lcom/google/android/apps/nexuslauncher/qsb/longpopup/SearchOptionsPopup;->k()LI1/g;
...
.method public final l(Landroid/view/View;)V
    ...
    .line 4
    iget-object v0, p0, Lcom/google/android/apps/nexuslauncher/qsb/longpopup/SearchOptionsPopup;->e:LI1/f;
...
.method public onLongClick(Landroid/view/View;)Z
    ...
    iget-object v2, p0, Lcom/android/launcher3/popup/ArrowPopup;->mLauncher:Lcom/android/launcher3/statemanager/StatefulActivity;
    ...
    invoke-direct {v1, v2, v4, v0, v3}, LH1/K;-><init>(Landroid/content/Context;Lcom/android/launcher3/util/ComponentKey;Landroid/content/pm/ShortcutInfo;Landroid/graphics/Rect;)V

    .line 9
    iget-object p0, p0, Lcom/google/android/apps/nexuslauncher/qsb/longpopup/SearchOptionsPopup;->e:LI1/f;

    invoke-virtual {p0, v1, p1}, LI1/f;->k(Lcom/android/launcher3/dragndrop/BaseItemDragListener;Landroid/view/View;)V
