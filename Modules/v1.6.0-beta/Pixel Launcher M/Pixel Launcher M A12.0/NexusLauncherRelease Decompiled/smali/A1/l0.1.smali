...
.method public constructor <init>(Lcom/android/launcher3/allapps/AllAppsContainerView;)V
    ...
    .line 2
    iput-object p1, p0, LA1/l0;->a:Lcom/android/launcher3/allapps/AllAppsContainerView;
...
.method public onDraw(Landroid/graphics/Canvas;Landroidx/recyclerview/widget/RecyclerView;Landroidx/recyclerview/widget/B0;)V
    ...
    .line 1
    iget-object p3, p0, LA1/l0;->a:Lcom/android/launcher3/allapps/AllAppsContainerView;
    ...
    .line 2
    iget-object v0, p0, LA1/l0;->a:Lcom/android/launcher3/allapps/AllAppsContainerView;
    ...
    instance-of v5, v4, LA1/S0;

    if-eqz v5, :cond_3

    .line 10
    check-cast v4, LA1/S0;

    .line 11
    invoke-virtual {v4}, LA1/S0;->a()LA1/j0;
    ...
    iget-object v6, p0, LA1/l0;->a:Lcom/android/launcher3/allapps/AllAppsContainerView;
    ...
    .line 14
    invoke-virtual {v5, p1, v3}, LA1/j0;->e(Landroid/graphics/Canvas;Landroid/view/View;)V

    goto :goto_1

    .line 15
    :cond_1
    invoke-virtual {v4}, LA1/S0;->c()Z
    ...
    .line 16
    invoke-virtual {v4}, LA1/S0;->b()Ljava/lang/String;
    ...
    invoke-direct {v7, v5, v8, v9}, LA1/k0;-><init>(LA1/j0;II)V
    ...
    check-cast v6, LA1/k0;

    .line 19
    invoke-virtual {v6, v5, v3}, LA1/k0;->g(LA1/j0;Landroid/view/View;)V
    ...
    .line 21
    :cond_2
    invoke-virtual {v5, p1, v3}, LA1/j0;->f(Landroid/graphics/Canvas;Landroid/view/View;)V
    ...
    check-cast p2, LA1/k0;

    .line 23
    invoke-virtual {p2, p1}, LA1/k0;->h(Landroid/graphics/Canvas;)V
