...
.method public static constructor <clinit>()V
    ...
    sput v0, Landroidx/core/widget/c;->s:I
...
.method public constructor <init>(Landroid/view/View;)V
    ...
    iput-object v0, p0, Landroidx/core/widget/c;->c:Landroid/view/animation/Interpolator;
    ...
    iput-object v1, p0, Landroidx/core/widget/c;->f:[F

    new-array v1, v0, [F

    fill-array-data v1, :array_1

    iput-object v1, p0, Landroidx/core/widget/c;->g:[F
    ...
    iput-object v0, p0, Landroidx/core/widget/c;->l:[F
    ...
    sget p1, Landroidx/core/widget/c;->s:I
...
.method public c()V
    ...
    iget-object p0, p0, Landroidx/core/widget/c;->d:Landroid/view/View;
...
.method public final d(IFFF)F
    ...
    invoke-virtual {p0, v0, p3, v1, p2}, Landroidx/core/widget/c;->h(FFFF)F
    ...
    :cond_0
    iget-object p3, p0, Landroidx/core/widget/c;->j:[F
    ...
    iget-object p0, p0, Landroidx/core/widget/c;->l:[F
    ...
    invoke-static {p2, v1, p0}, Landroidx/core/widget/c;->e(FFF)F
    ...
    invoke-static {p1, v1, p0}, Landroidx/core/widget/c;->e(FFF)F
...
.method public final g(FF)F
    ...
    :cond_3
    iget-boolean p0, p0, Landroidx/core/widget/c;->p:Z
...
.method public final h(FFFF)F
    ...
    invoke-virtual {p0, p4, p1}, Landroidx/core/widget/c;->g(FF)F

    move-result p3

    sub-float/2addr p2, p4

    invoke-virtual {p0, p2, p1}, Landroidx/core/widget/c;->g(FF)F
    ...
    iget-object p0, p0, Landroidx/core/widget/c;->c:Landroid/view/animation/Interpolator;
    ...
    invoke-static {p0, p1, p2}, Landroidx/core/widget/c;->e(FFF)F
...
.method public final i()V
    ...
    :cond_0
    iget-object p0, p0, Landroidx/core/widget/c;->b:Landroidx/core/widget/a;
...
.method public m(Z)Landroidx/core/widget/c;
    ...
    invoke-virtual {p0}, Landroidx/core/widget/c;->i()V
...
.method public n(FF)Landroidx/core/widget/c;
    ...
    iget-object v0, p0, Landroidx/core/widget/c;->g:[F
...
.method public onTouch(Landroid/view/View;Landroid/view/MotionEvent;)Z
    ...
    invoke-virtual {p0, v1, v0, v3, v4}, Landroidx/core/widget/c;->d(IFFF)F
    ...
    invoke-virtual {p0, v2, p2, p1, v3}, Landroidx/core/widget/c;->d(IFFF)F
    ...
    invoke-virtual {p0}, Landroidx/core/widget/c;->v()V
...
.method public final v()V
    ...
    invoke-direct {v0, p0}, Landroidx/core/widget/b;-><init>(Landroidx/core/widget/c;)V

    iput-object v0, p0, Landroidx/core/widget/c;->e:Ljava/lang/Runnable;
    ...
    iput-boolean v0, p0, Landroidx/core/widget/c;->n:Z

    iget-boolean v1, p0, Landroidx/core/widget/c;->m:Z

    if-nez v1, :cond_1

    iget v1, p0, Landroidx/core/widget/c;->i:I

    if-lez v1, :cond_1

    iget-object v2, p0, Landroidx/core/widget/c;->d:Landroid/view/View;

    iget-object v3, p0, Landroidx/core/widget/c;->e:Ljava/lang/Runnable;

    int-to-long v4, v1

    invoke-static {v2, v3, v4, v5}, LL/U;->a0(Landroid/view/View;Ljava/lang/Runnable;J)V

    goto :goto_0

    :cond_1
    iget-object v1, p0, Landroidx/core/widget/c;->e:Ljava/lang/Runnable;

    invoke-interface {v1}, Ljava/lang/Runnable;->run()V

    :goto_0
    iput-boolean v0, p0, Landroidx/core/widget/c;->m:Z
