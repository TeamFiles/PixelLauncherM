...
.method private static clearOldCacheFiles(Landroid/content/Context;)V
    ...
    invoke-direct {v1, p0}, Lcom/android/quickstep/util/k;-><init>(Landroid/content/Context;)V
...
.method private static synthetic lambda$clearOldCacheFiles$5(Landroid/content/Context;)V
    ...
    new-instance p0, Lcom/android/quickstep/util/l;

    invoke-direct {p0}, Lcom/android/quickstep/util/l;-><init>()V
...
.method private static synthetic lambda$startShareActivity$0(Landroid/content/Context;Ljava/util/function/Supplier;Landroid/graphics/Rect;Landroid/content/Intent;Ljava/lang/String;)V
    ...
    new-instance v4, Lcom/android/quickstep/util/g;

    invoke-direct {v4}, Lcom/android/quickstep/util/g;-><init>()V
...
.method public static persistBitmapAndStartActivity(Landroid/content/Context;Landroid/graphics/Bitmap;Landroid/graphics/Rect;Landroid/content/Intent;Ljava/util/function/BiFunction;Ljava/lang/String;Landroid/view/View;)V
    ...
    new-instance p3, Lcom/android/quickstep/util/i;

    invoke-direct {p3, p0, p1, p6}, Lcom/android/quickstep/util/i;-><init>(Landroid/content/Context;[Landroid/content/Intent;Landroid/view/View;)V
    ...
    new-instance p3, Lcom/android/quickstep/util/j;

    invoke-direct {p3, p0, p1, p6}, Lcom/android/quickstep/util/j;-><init>(Landroid/content/Context;[Landroid/content/Intent;Landroid/view/View;)V
...
.method public static startShareActivity(Landroid/content/Context;Ljava/util/function/Supplier;Landroid/graphics/Rect;Landroid/content/Intent;Ljava/lang/String;)V
    ...
    new-instance v7, Lcom/android/quickstep/util/f;
    ...
    invoke-direct/range {v1 .. v6}, Lcom/android/quickstep/util/f;-><init>(Landroid/content/Context;Ljava/util/function/Supplier;Landroid/graphics/Rect;Landroid/content/Intent;Ljava/lang/String;)V
...
.method public static startShareActivity(Landroid/content/Context;Ljava/util/function/Supplier;Landroid/graphics/Rect;Landroid/content/Intent;Ljava/lang/String;Landroid/view/View;)V
    ...
    new-instance v8, Lcom/android/quickstep/util/h;
    ...
    invoke-direct/range {v1 .. v7}, Lcom/android/quickstep/util/h;-><init>(Landroid/content/Context;Ljava/util/function/Supplier;Landroid/graphics/Rect;Landroid/content/Intent;Ljava/lang/String;Landroid/view/View;)V
