...
.method public static synthetic k(Lcom/android/quickstep/interaction/OverviewGestureTutorialController;)V
    .locals 0
...
.method private synthetic lambda$onNavBarGestureAttempted$0()V
    ...
    .line 1
    invoke-virtual {p0}, Lcom/android/quickstep/interaction/SwipeUpGestureTutorialController;->resetFakeTaskView()V
...
.method public getMockAppTaskThumbnailResId(Z)I
    ...
    .line 1
    sget p0, Lcom/android/launcher3/R$drawable;->mock_conversations_list:I
...
.method public onNavBarGestureAttempted(Lcom/android/quickstep/interaction/NavBarGestureHandler$NavBarGestureResult;Landroid/graphics/PointF;)V
    ...
    invoke-direct {p1, v2, v3}, Lcom/android/launcher3/anim/PendingAnimation;-><init>(J)V
    ...
    .line 12
    invoke-virtual {p1, p2, v0, v2, v3}, Lcom/android/launcher3/anim/PendingAnimation;->setFloat(Ljava/lang/Object;Landroid/util/FloatProperty;FLandroid/animation/TimeInterpolator;)V
    ...
    .line 18
    invoke-virtual {p1}, Lcom/android/quickstep/interaction/TutorialFragment;->getNumSteps()I
    ...
    .line 20
    sget p1, Lcom/android/launcher3/R$string;->overview_gesture_feedback_complete_with_follow_up:I

    goto :goto_0

    .line 21
    :cond_3
    sget p1, Lcom/android/launcher3/R$string;->overview_gesture_feedback_complete_without_follow_up:I

    .line 22
    :goto_0
    invoke-virtual {p0, p1, v1}, Lcom/android/quickstep/interaction/TutorialController;->showFeedback(IZ)V
    ...
    invoke-direct {p1, p0}, Li1/h;-><init>(Lcom/android/quickstep/interaction/OverviewGestureTutorialController;)V
