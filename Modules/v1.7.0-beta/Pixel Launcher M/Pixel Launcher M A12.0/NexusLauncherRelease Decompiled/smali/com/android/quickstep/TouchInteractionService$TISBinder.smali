...
.method public static synthetic a(Lcom/android/launcher3/util/WindowBounds;)V
    .locals 0
...
.method public static synthetic b(Lcom/android/quickstep/TouchInteractionService$TISBinder;Landroid/graphics/Region;)V
    .locals 0
...
.method public static synthetic c(Lcom/android/quickstep/TouchInteractionService$TISBinder;Z)V
    ...
    invoke-direct {p0, p1}, Lcom/android/quickstep/TouchInteractionService$TISBinder;->lambda$onAssistantAvailable$2(Z)V
...
.method public static synthetic d(Lcom/android/quickstep/TouchInteractionService$TISBinder;Lcom/android/systemui/shared/recents/ISystemUiProxy;Lcom/android/wm/shell/pip/IPip;Lcom/android/wm/shell/splitscreen/ISplitScreen;Lcom/android/wm/shell/onehanded/IOneHanded;Lcom/android/wm/shell/transition/IShellTransitions;Lcom/android/wm/shell/startingsurface/IStartingWindow;Lcom/android/systemui/shared/system/smartspace/ISmartspaceTransitionController;)V
    ...
    invoke-direct/range {p0 .. p7}, Lcom/android/quickstep/TouchInteractionService$TISBinder;->lambda$onInitialize$1(Lcom/android/systemui/shared/recents/ISystemUiProxy;Lcom/android/wm/shell/pip/IPip;Lcom/android/wm/shell/splitscreen/ISplitScreen;Lcom/android/wm/shell/onehanded/IOneHanded;Lcom/android/wm/shell/transition/IShellTransitions;Lcom/android/wm/shell/startingsurface/IStartingWindow;Lcom/android/systemui/shared/system/smartspace/ISmartspaceTransitionController;)V

    return-void
.end method

.method public static synthetic e(Lcom/android/quickstep/TouchInteractionService$TISBinder;)V
    .locals 0

    invoke-direct {p0}, Lcom/android/quickstep/TouchInteractionService$TISBinder;->lambda$onInitialize$0()V

    return-void
.end method

.method public static synthetic f(Lcom/android/quickstep/TouchInteractionService$TISBinder;IIIZ)V
    .locals 0

    invoke-direct {p0, p1, p2, p3, p4}, Lcom/android/quickstep/TouchInteractionService$TISBinder;->lambda$onImeWindowStatusChanged$7(IIIZ)V

    return-void
.end method

.method public static synthetic g(Lcom/android/quickstep/TouchInteractionService$TISBinder;I)V
    .locals 0
...
.method private synthetic lambda$onAssistantAvailable$2(Z)V
    .locals 1
    ...
    invoke-static {p0}, Lcom/android/quickstep/TouchInteractionService;->access$500(Lcom/android/quickstep/TouchInteractionService;)V
...
.method private synthetic lambda$onImeWindowStatusChanged$7(IIIZ)V
    .locals 0
    ...
    invoke-virtual {p0, p1, p2, p3, p4}, Lcom/android/launcher3/taskbar/TaskbarManager;->updateImeStatus(IIIZ)V
...
.method private synthetic lambda$onInitialize$0()V
    ...
    .line 2
    invoke-static {p0}, Lcom/android/quickstep/TouchInteractionService;->access$800(Lcom/android/quickstep/TouchInteractionService;)Lcom/android/quickstep/OverviewComponentObserver;
    ...
    .line 3
    :cond_0
    invoke-virtual {p0}, Lcom/android/quickstep/BaseActivityInterface;->onOverviewServiceBound()V
...
.method private synthetic lambda$onInitialize$1(Lcom/android/systemui/shared/recents/ISystemUiProxy;Lcom/android/wm/shell/pip/IPip;Lcom/android/wm/shell/splitscreen/ISplitScreen;Lcom/android/wm/shell/onehanded/IOneHanded;Lcom/android/wm/shell/transition/IShellTransitions;Lcom/android/wm/shell/startingsurface/IStartingWindow;Lcom/android/systemui/shared/system/smartspace/ISmartspaceTransitionController;)V
    ...
    invoke-virtual/range {v2 .. v9}, Lcom/android/quickstep/SystemUiProxy;->setProxy(Lcom/android/systemui/shared/recents/ISystemUiProxy;Lcom/android/wm/shell/pip/IPip;Lcom/android/wm/shell/splitscreen/ISplitScreen;Lcom/android/wm/shell/onehanded/IOneHanded;Lcom/android/wm/shell/transition/IShellTransitions;Lcom/android/wm/shell/startingsurface/IStartingWindow;Lcom/android/systemui/shared/system/smartspace/ISmartspaceTransitionController;)V
    ...
    invoke-static {v1}, Lcom/android/quickstep/TouchInteractionService;->access$600(Lcom/android/quickstep/TouchInteractionService;)V
    ...
    invoke-static {v1, v2}, Lcom/android/quickstep/TouchInteractionService;->access$700(Lcom/android/quickstep/TouchInteractionService;Z)V
    ...
    invoke-direct {v2, p0}, Lf1/p2;-><init>(Lcom/android/quickstep/TouchInteractionService$TISBinder;)V

    invoke-virtual {v1, v2}, Lcom/android/quickstep/RecentsAnimationDeviceState;->runOnUserUnlocked(Ljava/lang/Runnable;)V
...
.method private synthetic lambda$onSystemUiStateChanged$4(I)V
    ...
    invoke-static {p0, v0}, Lcom/android/quickstep/TouchInteractionService;->access$400(Lcom/android/quickstep/TouchInteractionService;I)V
...
.method public onActiveNavBarRegionChanges(Landroid/graphics/Region;)V
    ...
    invoke-direct {v1, p0, p1}, Lf1/t2;-><init>(Lcom/android/quickstep/TouchInteractionService$TISBinder;Landroid/graphics/Region;)V
...
.method public onAssistantAvailable(Z)V
    ...
    invoke-direct {v1, p0, p1}, Lf1/v2;-><init>(Lcom/android/quickstep/TouchInteractionService$TISBinder;Z)V
...
.method public onAssistantVisibilityChanged(F)V
    ...
    invoke-direct {v1, p0, p1}, Lf1/q2;-><init>(Lcom/android/quickstep/TouchInteractionService$TISBinder;F)V
...
.method public onImeWindowStatusChanged(ILandroid/os/IBinder;IIZ)V
    ...
    invoke-direct/range {v0 .. v5}, Lf1/s2;-><init>(Lcom/android/quickstep/TouchInteractionService$TISBinder;IIIZ)V

    invoke-virtual {p2, v6}, Lcom/android/launcher3/util/LooperExecutor;->execute(Ljava/lang/Runnable;)V
...
.method public onInitialize(Landroid/os/Bundle;)V
    ...
    .line 12
    invoke-static {p1}, Lcom/android/systemui/shared/system/smartspace/ISmartspaceTransitionController$Stub;->asInterface(Landroid/os/IBinder;)Lcom/android/systemui/shared/system/smartspace/ISmartspaceTransitionController;
...
.method public onSplitScreenSecondaryBoundsChanged(Landroid/graphics/Rect;Landroid/graphics/Rect;)V
    ...
    invoke-direct {p2, p0}, Lf1/o2;-><init>(Lcom/android/launcher3/util/WindowBounds;)V
...
.method public onSystemUiStateChanged(I)V
    ...
    invoke-direct {v1, p0, p1}, Lf1/r2;-><init>(Lcom/android/quickstep/TouchInteractionService$TISBinder;I)V
