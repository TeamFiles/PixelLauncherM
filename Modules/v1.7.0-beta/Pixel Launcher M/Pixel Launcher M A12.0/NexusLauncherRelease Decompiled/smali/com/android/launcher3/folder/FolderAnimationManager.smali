...
.method public getAnimator()Landroid/animation/AnimatorSet;
    ...
    sget v15, Lcom/android/launcher3/R$attr;->folderFillColor:I
    ...
    .line 35
    iget-boolean v15, v9, Lcom/android/launcher3/folder/FolderAnimationManager;->mIsOpening:Z
    ...
    .line 37
    :goto_1
    iget-object v13, v9, Lcom/android/launcher3/folder/FolderAnimationManager;->mPreviewBackground:Lcom/android/launcher3/folder/PreviewBackground;

    .line 38
    invoke-virtual {v13}, Lcom/android/launcher3/folder/PreviewBackground;->getBackgroundAlpha()I

    move-result v13

    .line 39
    invoke-static {v5, v13}, Lcom/android/launcher3/icons/GraphicsUtils;->setColorAlphaBound(II)I

    move-result v5

    .line 40
    iget-object v13, v9, Lcom/android/launcher3/folder/FolderAnimationManager;->mFolderBackground:Landroid/graphics/drawable/GradientDrawable;
    ...
    invoke-direct {v8, v0, v1, v13, v3}, Landroid/graphics/Rect;-><init>(IIII)V
    ...
    invoke-virtual {v9, v0, v1, v5, v15}, Lcom/android/launcher3/folder/FolderAnimationManager;->getAnimator(Landroid/graphics/drawable/GradientDrawable;Ljava/lang/String;II)Landroid/animation/ObjectAnimator;
    ...
    invoke-virtual {v9, v0, v2, v14, v4}, Lcom/android/launcher3/folder/FolderAnimationManager;->getAnimator(Landroid/view/View;Landroid/util/Property;FF)Landroid/animation/Animator;
    ...
    iget v1, v0, Lcom/android/launcher3/DeviceProfile;->folderCellLayoutBorderSpacingPx:I
