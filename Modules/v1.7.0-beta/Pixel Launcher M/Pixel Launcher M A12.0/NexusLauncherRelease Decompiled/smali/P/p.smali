...
.method public static e(Landroid/widget/TextView;)LJ/g;
    .locals 4
    ...
    invoke-direct {v0, p0}, LJ/g;-><init>(Landroid/text/PrecomputedText$Params;)V
    ...
    invoke-direct {v1, v2}, LJ/f;-><init>(Landroid/text/TextPaint;)V
    ...
    invoke-virtual {v1, v2}, LJ/f;->b(I)LJ/f;
    ...
    invoke-virtual {v1, v2}, LJ/f;->c(I)LJ/f;
    ...
    .line 7
    invoke-static {p0}, LP/p;->d(Landroid/widget/TextView;)Landroid/text/TextDirectionHeuristic;

    move-result-object p0

    invoke-virtual {v1, p0}, LJ/f;->d(Landroid/text/TextDirectionHeuristic;)LJ/f;

    .line 8
    :cond_2
    invoke-virtual {v1}, LJ/f;->a()LJ/g;
...
.method public static f(Landroid/widget/TextView;Landroid/content/res/ColorStateList;)V
    ...
    invoke-interface {p0, p1}, LP/u;->h(Landroid/content/res/ColorStateList;)V
...
.method public static g(Landroid/widget/TextView;Landroid/graphics/PorterDuff$Mode;)V
    ...
    invoke-interface {p0, p1}, LP/u;->e(Landroid/graphics/PorterDuff$Mode;)V
...
.method public static l(Landroid/widget/TextView;LJ/h;)V
    .locals 2
    ...
    .line 2
    invoke-virtual {p1}, LJ/h;->b()Landroid/text/PrecomputedText;
    ...
    .line 3
    :cond_0
    invoke-static {p0}, LP/p;->e(Landroid/widget/TextView;)LJ/g;

    move-result-object v0

    .line 4
    invoke-virtual {p1}, LJ/h;->a()LJ/g;

    move-result-object v1

    invoke-virtual {v0, v1}, LJ/g;->a(LJ/g;)Z
...
.method public static n(Landroid/widget/TextView;Landroid/view/ActionMode$Callback;)Landroid/view/ActionMode$Callback;
    ...
    invoke-direct {v0, p1, p0}, LP/o;-><init>(Landroid/view/ActionMode$Callback;Landroid/widget/TextView;)V
