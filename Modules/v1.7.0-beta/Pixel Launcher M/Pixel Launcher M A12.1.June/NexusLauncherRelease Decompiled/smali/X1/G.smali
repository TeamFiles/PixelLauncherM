...
.method public constructor <init>(Landroid/content/Context;Lcom/android/launcher3/util/ComponentKey;Landroid/content/pm/ShortcutInfo;Landroid/graphics/Rect;)V
    ...
    .line 3
    iput-object p2, p0, LX1/G;->c:Lcom/android/launcher3/util/ComponentKey;

    .line 4
    iput-object p3, p0, LX1/G;->e:Landroid/content/pm/ShortcutInfo;
    ...
    iput-object p2, p0, LX1/G;->f:Lcom/android/launcher3/icons/BitmapInfo;
    ...
    iput-object p4, p0, LX1/G;->d:Lcom/android/launcher3/model/data/WorkspaceItemInfo;
...
.method public static synthetic a(LX1/G;)Lcom/android/launcher3/model/data/WorkspaceItemInfo;
    .locals 0

    .line 1
    iget-object p0, p0, LX1/G;->d:Lcom/android/launcher3/model/data/WorkspaceItemInfo;

    return-object p0
.end method

.method public static synthetic b(LX1/G;)Lcom/android/launcher3/Launcher;
    .locals 0
...
.method public static synthetic c(LX1/G;)Lcom/android/launcher3/icons/BitmapInfo;
    .locals 0

    .line 1
    iget-object p0, p0, LX1/G;->f:Lcom/android/launcher3/icons/BitmapInfo;

    return-object p0
.end method

.method public static synthetic d(LX1/G;)Landroid/content/pm/ShortcutInfo;
    .locals 0

    .line 1
    iget-object p0, p0, LX1/G;->e:Landroid/content/pm/ShortcutInfo;

    return-object p0
.end method

.method public static synthetic e(LX1/G;)Landroid/content/Context;
    .locals 0
...
.method public createDragHelper()Lcom/android/launcher3/widget/PendingItemDragHelper;
    ...
    iget-object v3, p0, LX1/G;->c:Lcom/android/launcher3/util/ComponentKey;
    ...
    invoke-direct {v2, p0, v4, v3}, LX1/F;-><init>(LX1/G;Landroid/content/ComponentName;Landroid/os/UserHandle;)V
