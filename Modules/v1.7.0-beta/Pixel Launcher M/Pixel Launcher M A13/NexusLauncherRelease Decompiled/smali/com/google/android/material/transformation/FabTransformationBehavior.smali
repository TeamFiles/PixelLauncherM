...
.method public J(Landroid/view/View;Landroid/view/View;ZZ)Landroid/animation/AnimatorSet;
    ...
    invoke-virtual {p0, v0, v11}, Lcom/google/android/material/transformation/FabTransformationBehavior;->e0(Landroid/content/Context;Z)Lo2/g;
    ...
    invoke-virtual/range {v0 .. v7}, Lcom/google/android/material/transformation/FabTransformationBehavior;->X(Landroid/view/View;Landroid/view/View;ZZLo2/g;Ljava/util/List;Ljava/util/List;)V
    ...
    invoke-virtual/range {v0 .. v8}, Lcom/google/android/material/transformation/FabTransformationBehavior;->c0(Landroid/view/View;Landroid/view/View;ZZLo2/g;Ljava/util/List;Ljava/util/List;Landroid/graphics/RectF;)V
    ...
    invoke-virtual/range {v0 .. v5}, Lcom/google/android/material/transformation/FabTransformationBehavior;->W(Landroid/view/View;Landroid/view/View;ZLo2/g;Ljava/util/List;)V

    move/from16 v4, p4

    move-object v5, v12

    invoke-virtual/range {v0 .. v7}, Lcom/google/android/material/transformation/FabTransformationBehavior;->Z(Landroid/view/View;Landroid/view/View;ZZLo2/g;Ljava/util/List;Ljava/util/List;)V
    ...
    invoke-virtual/range {v0 .. v9}, Lcom/google/android/material/transformation/FabTransformationBehavior;->Y(Landroid/view/View;Landroid/view/View;ZZLo2/g;FFLjava/util/List;Ljava/util/List;)V

    move-object v6, v13

    move-object v7, v14

    invoke-virtual/range {v0 .. v7}, Lcom/google/android/material/transformation/FabTransformationBehavior;->V(Landroid/view/View;Landroid/view/View;ZZLo2/g;Ljava/util/List;Ljava/util/List;)V

    invoke-virtual/range {v0 .. v7}, Lcom/google/android/material/transformation/FabTransformationBehavior;->U(Landroid/view/View;Landroid/view/View;ZZLo2/g;Ljava/util/List;Ljava/util/List;)V
    ...
    invoke-direct {v1, p0, v11, v3, v2}, Lo2/c;-><init>(Lcom/google/android/material/transformation/FabTransformationBehavior;ZLandroid/view/View;Landroid/view/View;)V
...
.method public final L(Landroid/view/View;Lo2/g;LP1/i;LP1/i;FFFFLandroid/graphics/RectF;)V
    .locals 0

    invoke-virtual {p0, p2, p3, p5, p7}, Lcom/google/android/material/transformation/FabTransformationBehavior;->S(Lo2/g;LP1/i;FF)F

    move-result p3

    invoke-virtual {p0, p2, p4, p6, p8}, Lcom/google/android/material/transformation/FabTransformationBehavior;->S(Lo2/g;LP1/i;FF)F
...
.method public final N(FFZLo2/g;)Landroid/util/Pair;
    .locals 0
    ...
    :cond_2
    iget-object p0, p4, Lo2/g;->a:LP1/h;

    const-string p1, "translationXCurveUpwards"

    invoke-virtual {p0, p1}, LP1/h;->e(Ljava/lang/String;)LP1/i;

    move-result-object p0

    iget-object p1, p4, Lo2/g;->a:LP1/h;
...
.method public final O(Landroid/view/View;Landroid/view/View;LP1/j;)F
    .locals 2
    ...
    invoke-virtual {p0, p1, p2, p3}, Lcom/google/android/material/transformation/FabTransformationBehavior;->Q(Landroid/view/View;Landroid/view/View;LP1/j;)F
...
.method public final P(Landroid/view/View;Landroid/view/View;LP1/j;)F
    .locals 2
    ...
    invoke-virtual {p0, p1, p2, p3}, Lcom/google/android/material/transformation/FabTransformationBehavior;->R(Landroid/view/View;Landroid/view/View;LP1/j;)F
...
.method public final Q(Landroid/view/View;Landroid/view/View;LP1/j;)F
    .locals 2
...
.method public final R(Landroid/view/View;Landroid/view/View;LP1/j;)F
    .locals 2
...
.method public final S(Lo2/g;LP1/i;FF)F
    .locals 6
    ...
    iget-object p0, p1, Lo2/g;->a:LP1/h;
    ...
    invoke-static {p3, p4, p0}, LP1/a;->a(FFF)F
...
.method public final U(Landroid/view/View;Landroid/view/View;ZZLo2/g;Ljava/util/List;Ljava/util/List;)V
    .locals 0
    ...
    :cond_3
    sget-object p1, LP1/d;->a:Landroid/util/Property;
    ...
    :goto_0
    iget-object p1, p5, Lo2/g;->a:LP1/h;
...
.method public final V(Landroid/view/View;Landroid/view/View;ZZLo2/g;Ljava/util/List;Ljava/util/List;)V
    .locals 1

    instance-of p7, p2, LX1/i;
    ...
    invoke-interface {p2, p0}, LX1/i;->g(I)V

    :cond_1
    sget-object p0, LX1/g;->a:Landroid/util/Property;
    ...
    :cond_2
    sget-object p1, LX1/g;->a:Landroid/util/Property;
...
.method public final W(Landroid/view/View;Landroid/view/View;ZLo2/g;Ljava/util/List;)V
    .locals 6

    iget-object v0, p4, Lo2/g;->b:LP1/j;

    invoke-virtual {p0, p1, p2, v0}, Lcom/google/android/material/transformation/FabTransformationBehavior;->Q(Landroid/view/View;Landroid/view/View;LP1/j;)F

    move-result v0

    iget-object v1, p4, Lo2/g;->b:LP1/j;

    invoke-virtual {p0, p1, p2, v1}, Lcom/google/android/material/transformation/FabTransformationBehavior;->R(Landroid/view/View;Landroid/view/View;LP1/j;)F

    move-result p2

    invoke-virtual {p0, v0, p2, p3, p4}, Lcom/google/android/material/transformation/FabTransformationBehavior;->N(FFZLo2/g;)Landroid/util/Pair;
    ...
    invoke-virtual {p4, p0}, LP1/i;->a(Landroid/animation/Animator;)V
...
.method public final X(Landroid/view/View;Landroid/view/View;ZZLo2/g;Ljava/util/List;Ljava/util/List;)V
    .locals 0
    ...
    invoke-static {p1}, LL/U;->t(Landroid/view/View;)F
...
.method public final Y(Landroid/view/View;Landroid/view/View;ZZLo2/g;FFLjava/util/List;Ljava/util/List;)V
    .locals 17
    ...
    iget-object v1, v10, Lo2/g;->b:LP1/j;

    invoke-virtual {v8, v0, v9, v1}, Lcom/google/android/material/transformation/FabTransformationBehavior;->O(Landroid/view/View;Landroid/view/View;LP1/j;)F

    move-result v1

    iget-object v2, v10, Lo2/g;->b:LP1/j;

    invoke-virtual {v8, v0, v9, v2}, Lcom/google/android/material/transformation/FabTransformationBehavior;->P(Landroid/view/View;Landroid/view/View;LP1/j;)F
    ...
    invoke-virtual {v0, v2}, Ld2/k;->k(Landroid/graphics/Rect;)Z
    ...
    iget-object v0, v10, Lo2/g;->a:LP1/h;

    const-string v2, "expansion"

    invoke-virtual {v0, v2}, LP1/h;->e(Ljava/lang/String;)LP1/i;
    ...
    invoke-direct {v0, v1, v11, v13}, LX1/h;-><init>(FFF)V

    invoke-interface {v12, v0}, LX1/i;->c(LX1/h;)V

    :cond_1
    if-eqz p4, :cond_2

    invoke-interface {v12}, LX1/i;->a()LX1/h;
    ...
    invoke-static/range {v2 .. v7}, Le2/a;->b(FFFFFF)F

    move-result v0

    invoke-static {v12, v1, v11, v0}, LX1/b;->a(LX1/i;FFF)Landroid/animation/Animator;

    move-result-object v10

    new-instance v0, Lo2/f;

    invoke-direct {v0, v8, v12}, Lo2/f;-><init>(Lcom/google/android/material/transformation/FabTransformationBehavior;LX1/i;)V
    ...
    iget v6, v0, LX1/h;->c:F

    invoke-static {v12, v1, v11, v13}, LX1/b;->a(LX1/i;FFF)Landroid/animation/Animator;
    ...
    :goto_0
    invoke-virtual {v14, v10}, LP1/i;->a(Landroid/animation/Animator;)V

    move-object/from16 v0, p8

    invoke-interface {v0, v10}, Ljava/util/List;->add(Ljava/lang/Object;)Z

    invoke-static {v12}, LX1/b;->b(LX1/i;)Landroid/animation/Animator$AnimatorListener;
...
.method public final Z(Landroid/view/View;Landroid/view/View;ZZLo2/g;Ljava/util/List;Ljava/util/List;)V
    .locals 4
    ...
    invoke-direct {p4, p0, p2}, Lo2/d;-><init>(Lcom/google/android/material/transformation/FabTransformationBehavior;Landroid/view/View;)V
    ...
    iget-object p2, p5, Lo2/g;->a:LP1/h;

    const-string p4, "iconFade"

    invoke-virtual {p2, p4}, LP1/h;->e(Ljava/lang/String;)LP1/i;
    ...
    invoke-direct {p2, p0, v0, p1}, Lo2/e;-><init>(Lcom/google/android/material/transformation/FabTransformationBehavior;LX1/i;Landroid/graphics/drawable/Drawable;)V
...
.method public final c0(Landroid/view/View;Landroid/view/View;ZZLo2/g;Ljava/util/List;Ljava/util/List;Landroid/graphics/RectF;)V
    .locals 15
    ...
    iget-object v5, v4, Lo2/g;->b:LP1/j;

    invoke-virtual {p0, v1, v2, v5}, Lcom/google/android/material/transformation/FabTransformationBehavior;->Q(Landroid/view/View;Landroid/view/View;LP1/j;)F

    move-result v5

    iget-object v6, v4, Lo2/g;->b:LP1/j;

    invoke-virtual {p0, v1, v2, v6}, Lcom/google/android/material/transformation/FabTransformationBehavior;->R(Landroid/view/View;Landroid/view/View;LP1/j;)F

    move-result v1

    invoke-virtual {p0, v5, v1, v3, v4}, Lcom/google/android/material/transformation/FabTransformationBehavior;->N(FFZLo2/g;)Landroid/util/Pair;
    ...
    invoke-virtual/range {v0 .. v9}, Lcom/google/android/material/transformation/FabTransformationBehavior;->L(Landroid/view/View;Lo2/g;LP1/i;LP1/i;FFFFLandroid/graphics/RectF;)V
    ...
    :goto_0
    invoke-virtual {v11, v13}, LP1/i;->a(Landroid/animation/Animator;)V
...
.method public abstract e0(Landroid/content/Context;Z)Lo2/g;
.end method
