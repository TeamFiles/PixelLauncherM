...
.method public static b(Ljava/util/Set;)Ljava/util/Set;
    ...
    invoke-static {v1}, LZ/d;->a(Landroidx/slice/SliceSpec;)Landroid/app/slice/SliceSpec;
...
.method public static c(Landroid/app/slice/Slice;Landroid/content/Context;)Landroidx/slice/Slice;
    ...
    invoke-direct {v2, v3}, LZ/c;-><init>(Landroid/net/Uri;)V

    invoke-virtual {p0}, Landroid/app/slice/Slice;->getHints()Ljava/util/List;

    move-result-object v3

    invoke-virtual {v2, v3}, LZ/c;->b(Ljava/util/List;)LZ/c;

    invoke-virtual {p0}, Landroid/app/slice/Slice;->getSpec()Landroid/app/slice/SliceSpec;

    move-result-object v3

    invoke-static {v3}, LZ/d;->d(Landroid/app/slice/SliceSpec;)Landroidx/slice/SliceSpec;

    move-result-object v3

    invoke-virtual {v2, v3}, LZ/c;->q(Landroidx/slice/SliceSpec;)LZ/c;
    ...
    invoke-static {v4, p1}, LZ/d;->c(Landroid/app/slice/Slice;Landroid/content/Context;)Landroidx/slice/Slice;
    ...
    invoke-virtual {v2, v4, v3}, LZ/c;->m(Landroidx/slice/Slice;Ljava/lang/String;)LZ/c;
    ...
    invoke-virtual {v2, v4, v5, v3}, LZ/c;->k(Landroid/app/RemoteInput;Ljava/lang/String;Ljava/util/List;)LZ/c;
    ...
    invoke-static {p1, v4}, Landroidx/core/graphics/drawable/IconCompat;->b(Landroid/content/Context;Landroid/graphics/drawable/Icon;)Landroidx/core/graphics/drawable/IconCompat;
    ...
    invoke-virtual {v2, v4, v5, v3}, LZ/c;->d(Landroidx/core/graphics/drawable/IconCompat;Ljava/lang/String;Ljava/util/List;)LZ/c;
    :try_end_0
    ...
    invoke-virtual {v2, v4, v5, v3}, LZ/c;->n(Ljava/lang/CharSequence;Ljava/lang/String;Ljava/util/List;)LZ/c;
    ...
    invoke-virtual {v2, v4, v5, v6, v3}, LZ/c;->i(JLjava/lang/String;Ljava/util/List;)LZ/c;
    ...
    invoke-virtual {v2, v4, v5, v3}, LZ/c;->f(ILjava/lang/String;Ljava/util/List;)LZ/c;
    ...
    invoke-virtual {v2, v4}, LZ/c;->h(Landroidx/slice/SliceItem;)LZ/c;
    ...
    invoke-static {v5, p1}, LZ/d;->c(Landroid/app/slice/Slice;Landroid/content/Context;)Landroidx/slice/Slice;
    ...
    invoke-virtual {v2, v4, v5, v3}, LZ/c;->a(Landroid/app/PendingIntent;Landroidx/slice/Slice;Ljava/lang/String;)LZ/c;

    goto/16 :goto_0

    :cond_9
    invoke-virtual {v2}, LZ/c;->p()Landroidx/slice/Slice;
