...
# direct methods
.method public constructor <init>(LD1/F;Landroid/content/pm/LauncherActivityInfo;Lcom/android/launcher3/model/data/AppInfo;)V
    .locals 0

    iput-object p1, p0, LD1/D;->c:LD1/F;

    iput-object p3, p0, LD1/D;->b:Lcom/android/launcher3/model/data/AppInfo;
...
.method public static synthetic a(LD1/D;Lcom/android/launcher3/model/data/WorkspaceItemInfo;)Lcom/android/launcher3/model/data/WorkspaceItemInfo;
    .locals 0

    invoke-direct {p0, p1}, LD1/D;->b(Lcom/android/launcher3/model/data/WorkspaceItemInfo;)Lcom/android/launcher3/model/data/WorkspaceItemInfo;
...
.method private synthetic b(Lcom/android/launcher3/model/data/WorkspaceItemInfo;)Lcom/android/launcher3/model/data/WorkspaceItemInfo;
    ...
    iget-object p0, p0, LD1/D;->c:LD1/F;

    invoke-static {p0}, LD1/F;->f(LD1/F;)Lcom/android/launcher3/Launcher;
...
.method public createWorkspaceItemInfo()Lcom/android/launcher3/model/data/WorkspaceItemInfo;
    ...
    iget-object v1, p0, LD1/D;->c:LD1/F;

    invoke-static {v1}, LD1/F;->c(LD1/F;)Lcom/android/launcher3/Launcher;

    move-result-object v1

    iget-object v2, p0, LD1/D;->c:LD1/F;

    invoke-static {v2}, LD1/F;->a(LD1/F;)Landroid/content/pm/LauncherActivityInfo;

    move-result-object v2

    iget-object v3, p0, LD1/D;->c:LD1/F;

    invoke-static {v3}, LD1/F;->a(LD1/F;)Landroid/content/pm/LauncherActivityInfo;
    ...
    invoke-static {v1}, LD1/F;->d(LD1/F;)Lcom/android/launcher3/Launcher;
    ...
    invoke-direct {v2, p0, v0}, LD1/C;-><init>(LD1/D;Lcom/android/launcher3/model/data/WorkspaceItemInfo;)V
...
.method public getFullResIcon(Lcom/android/launcher3/icons/IconCache;)Landroid/graphics/drawable/Drawable;
    ...
    iget-object v0, p0, LD1/D;->b:Lcom/android/launcher3/model/data/AppInfo;
    ...
    invoke-static {p0}, LD1/F;->e(LD1/F;)Lcom/android/launcher3/Launcher;
