...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    invoke-direct {p1, p0}, LC1/s;-><init>(Lcom/google/android/apps/nexuslauncher/overview/ShareTargetsView;)V
    ...
    invoke-direct {p1, p0}, LC1/t;-><init>(Lcom/google/android/apps/nexuslauncher/overview/ShareTargetsView;)V
...
.method public static synthetic c(Lcom/google/android/apps/nexuslauncher/overview/ShareTargetsView;Lcom/android/launcher3/util/DisplayController$NavigationMode;)V
    .locals 0

    invoke-direct {p0, p1}, Lcom/google/android/apps/nexuslauncher/overview/ShareTargetsView;->o(Lcom/android/launcher3/util/DisplayController$NavigationMode;)V

    return-void
.end method

.method public static synthetic d(Lcom/google/android/apps/nexuslauncher/overview/ShareTargetsView;Landroid/widget/Button;Lcom/android/launcher3/icons/FastBitmapDrawable;)V
    .locals 0
...
.method public static synthetic e(Lcom/google/android/apps/nexuslauncher/overview/ShareTargetsView;Landroid/content/pm/ShortcutInfo;Landroid/app/prediction/AppTarget;Landroid/view/View;Landroid/view/View;Landroid/view/DragEvent;)Z
    .locals 0
...
.method public static synthetic f(Lcom/google/android/apps/nexuslauncher/overview/ShareTargetsView;Landroid/content/pm/ShortcutInfo;Landroid/app/prediction/AppTarget;Landroid/view/View;)V
    .locals 0
...
.method private synthetic l(Lcom/android/launcher3/LauncherAppState;Lcom/android/launcher3/model/data/WorkspaceItemInfo;Landroid/content/pm/ShortcutInfo;Landroid/widget/Button;)V
    ...
    invoke-direct {p3, p0, p4, p1}, LC1/x;-><init>(Lcom/google/android/apps/nexuslauncher/overview/ShareTargetsView;Landroid/widget/Button;Lcom/android/launcher3/icons/FastBitmapDrawable;)V
...
.method private synthetic m(Landroid/view/View;Landroid/view/DragEvent;)Z
    ...
    iget-object p2, p0, Lcom/google/android/apps/nexuslauncher/overview/ShareTargetsView;->f:LC1/A;

    iget-object p0, p0, Lcom/google/android/apps/nexuslauncher/overview/ShareTargetsView;->e:Ljava/lang/String;

    invoke-interface {p2, p0, v2}, LC1/A;->a(Ljava/lang/String;Z)V
    ...
    invoke-interface {p2, p0, v2}, LC1/A;->b(Landroid/graphics/RectF;Z)V
...
.method private synthetic n(Landroid/view/View;)V
    ...
    iget-object p1, p0, Lcom/google/android/apps/nexuslauncher/overview/ShareTargetsView;->f:LC1/A;

    iget-object p0, p0, Lcom/google/android/apps/nexuslauncher/overview/ShareTargetsView;->d:Landroid/graphics/RectF;

    invoke-interface {p1, p0, v0}, LC1/A;->b(Landroid/graphics/RectF;Z)V
    ...
    invoke-interface {p1, p0, v0}, LC1/A;->a(Ljava/lang/String;Z)V

    :goto_0
    return-void
.end method

.method private synthetic o(Lcom/android/launcher3/util/DisplayController$NavigationMode;)V
    .locals 5
...
.method private synthetic p(Landroid/content/pm/ShortcutInfo;Landroid/app/prediction/AppTarget;Landroid/view/View;Landroid/view/View;Landroid/view/DragEvent;)Z
    ...
    iget-object p4, p0, Lcom/google/android/apps/nexuslauncher/overview/ShareTargetsView;->f:LC1/A;

    iget-object p0, p0, Lcom/google/android/apps/nexuslauncher/overview/ShareTargetsView;->e:Ljava/lang/String;

    invoke-interface {p4, p0, p1, p2, v1}, LC1/A;->c(Ljava/lang/String;Landroid/content/pm/ShortcutInfo;Landroid/app/prediction/AppTarget;Z)V
    ...
    invoke-interface {p4, p0, p1, p2, v1}, LC1/A;->d(Landroid/graphics/RectF;Landroid/content/pm/ShortcutInfo;Landroid/app/prediction/AppTarget;Z)V
...
.method private synthetic q(Landroid/content/pm/ShortcutInfo;Landroid/app/prediction/AppTarget;Landroid/view/View;)V
    ...
    iget-object p3, p0, Lcom/google/android/apps/nexuslauncher/overview/ShareTargetsView;->f:LC1/A;

    iget-object p0, p0, Lcom/google/android/apps/nexuslauncher/overview/ShareTargetsView;->d:Landroid/graphics/RectF;

    invoke-interface {p3, p0, p1, p2, v0}, LC1/A;->d(Landroid/graphics/RectF;Landroid/content/pm/ShortcutInfo;Landroid/app/prediction/AppTarget;Z)V
    ...
    invoke-interface {p3, p0, p1, p2, v0}, LC1/A;->c(Ljava/lang/String;Landroid/content/pm/ShortcutInfo;Landroid/app/prediction/AppTarget;Z)V
...
.method public final h(Landroid/app/prediction/AppTarget;)V
    ...
    invoke-direct/range {v1 .. v6}, LC1/v;-><init>(Lcom/google/android/apps/nexuslauncher/overview/ShareTargetsView;Lcom/android/launcher3/LauncherAppState;Lcom/android/launcher3/model/data/WorkspaceItemInfo;Landroid/content/pm/ShortcutInfo;Landroid/widget/Button;)V
...
.method public i()V
    ...
    invoke-direct {v1, p0}, LC1/z;-><init>(Lcom/google/android/apps/nexuslauncher/overview/ShareTargetsView;)V
...
.method public j(Ljava/util/List;LC1/A;ZLandroid/graphics/RectF;Ljava/lang/String;)V
    .locals 1
    ...
    iput-object p2, p0, Lcom/google/android/apps/nexuslauncher/overview/ShareTargetsView;->f:LC1/A;
...
.method public u(Lcom/android/launcher3/DeviceProfile;)V
    ...
    invoke-virtual {p0, v1, p1, v0, p1}, Landroid/widget/LinearLayout;->setPadding(IIII)V
...
.method public w(Lcom/android/launcher3/util/DisplayController$NavigationMode;)V
    .locals 1

    new-instance v0, LC1/u;

    invoke-direct {v0, p0, p1}, LC1/u;-><init>(Lcom/google/android/apps/nexuslauncher/overview/ShareTargetsView;Lcom/android/launcher3/util/DisplayController$NavigationMode;)V
...
.method public final x(Landroid/view/View;Landroid/content/pm/ShortcutInfo;Landroid/app/prediction/AppTarget;)V
    ...
    invoke-direct {v0, p0, p2, p3, p1}, LC1/y;-><init>(Lcom/google/android/apps/nexuslauncher/overview/ShareTargetsView;Landroid/content/pm/ShortcutInfo;Landroid/app/prediction/AppTarget;Landroid/view/View;)V
...
.method public final y(Landroid/view/View;Landroid/content/pm/ShortcutInfo;Landroid/app/prediction/AppTarget;)V
    ...
    invoke-direct {v0, p0, p2, p3}, LC1/w;-><init>(Lcom/google/android/apps/nexuslauncher/overview/ShareTargetsView;Landroid/content/pm/ShortcutInfo;Landroid/app/prediction/AppTarget;)V
...
.method public final z()V
    ...
    invoke-static {v5, v1, v1, v7}, LN/a;->a(FFFF)Landroid/view/animation/Interpolator;
