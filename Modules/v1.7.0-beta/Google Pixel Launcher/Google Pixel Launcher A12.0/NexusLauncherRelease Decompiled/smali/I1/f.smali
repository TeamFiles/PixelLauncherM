...
.field public final n:LI1/g;

.field public o:Z


# direct methods
.method public constructor <init>(Lcom/google/android/apps/nexuslauncher/NexusLauncherActivity;LH1/I;Landroid/graphics/Rect;Landroid/graphics/Point;I)V
    .locals 2
    ...
    .line 2
    iput-object p1, p0, LI1/f;->b:Lcom/google/android/apps/nexuslauncher/NexusLauncherActivity;

    .line 3
    iput-object p2, p0, LI1/f;->d:LH1/I;
    ...
    iput-object p2, p0, LI1/f;->c:Landroid/graphics/Rect;
    ...
    iput-object p2, p0, LI1/f;->e:Landroid/graphics/Point;
    ...
    iput-object p2, p0, LI1/f;->f:Landroid/os/Handler;
    ...
    iput-object p2, p0, LI1/f;->i:Landroid/content/res/Configuration;
    ...
    iput-object p2, p0, LI1/f;->j:Lcom/android/launcher3/dragndrop/DragController;
    ...
    iput-object p2, p0, LI1/f;->h:Landroid/app/Application;
    ...
    invoke-direct {p3, p0, p4}, LI1/e;-><init>(LI1/f;Landroid/content/Context;)V

    iput-object p3, p0, LI1/f;->m:LI1/e;

    .line 13
    new-instance p4, LI1/g;

    invoke-direct {p4, p0, p3}, LI1/g;-><init>(LI1/f;Landroid/content/Context;)V

    iput-object p4, p0, LI1/f;->n:LI1/g;
    ...
    iput-object p5, p0, LI1/f;->g:Lcom/android/launcher3/util/SystemUiController;
...
.method public static synthetic a(LI1/f;)V
    .locals 0

    invoke-direct {p0}, LI1/f;->h()V

    return-void
.end method

.method public static synthetic b(LI1/f;)V
    .locals 0
...
.method public static synthetic c(LI1/f;)LI1/g;
    .locals 0

    .line 1
    iget-object p0, p0, LI1/f;->n:LI1/g;

    return-object p0
.end method

.method public static synthetic d(LI1/f;)Lcom/google/android/apps/nexuslauncher/NexusLauncherActivity;
    .locals 0

    .line 1
    iget-object p0, p0, LI1/f;->b:Lcom/google/android/apps/nexuslauncher/NexusLauncherActivity;

    return-object p0
.end method

.method public static f(Lcom/google/android/apps/nexuslauncher/NexusLauncherActivity;LH1/I;Landroid/content/Intent;)LI1/f;
    .locals 8
    ...
    invoke-direct/range {v2 .. v7}, LI1/f;-><init>(Lcom/google/android/apps/nexuslauncher/NexusLauncherActivity;LH1/I;Landroid/graphics/Rect;Landroid/graphics/Point;I)V
...
.method private synthetic h()V
    ...
    .line 1
    iget-object v0, p0, LI1/f;->n:LI1/g;
...
.method public e()V
    ...
    .line 1
    iget-boolean v0, p0, LI1/f;->l:Z

    if-nez v0, :cond_0

    .line 2
    iget-object v0, p0, LI1/f;->f:Landroid/os/Handler;

    new-instance v1, LI1/a;

    invoke-direct {v1, p0}, LI1/a;-><init>(LI1/f;)V
...
.method public g()Lcom/android/launcher3/util/SystemUiController;
    ...
    .line 1
    iget-object p0, p0, LI1/f;->g:Lcom/android/launcher3/util/SystemUiController;
...
.method public final i(Landroid/app/Activity;)V
    ...
    .line 1
    iget-object v0, p0, LI1/f;->b:Lcom/google/android/apps/nexuslauncher/NexusLauncherActivity;

    if-ne p1, v0, :cond_0

    .line 2
    invoke-virtual {p0}, LI1/f;->e()V
...
.method public final j()V
    ...
    iget-object v2, p0, LI1/f;->c:Landroid/graphics/Rect;

    invoke-direct {v1, v2}, Landroid/graphics/Rect;-><init>(Landroid/graphics/Rect;)V

    .line 4
    iget-object v2, p0, LI1/f;->e:Landroid/graphics/Point;
    ...
    .line 5
    iget-object v3, p0, LI1/f;->n:LI1/g;
    ...
    .line 8
    iget-object v0, p0, LI1/f;->d:LH1/I;

    invoke-virtual {v0}, LH1/I;->i()Landroid/content/pm/LauncherActivityInfo;
    ...
    .line 13
    iget-object v3, p0, LI1/f;->b:Lcom/google/android/apps/nexuslauncher/NexusLauncherActivity;
    ...
    .line 15
    iget-object v2, p0, LI1/f;->b:Lcom/google/android/apps/nexuslauncher/NexusLauncherActivity;

    iget-object v3, p0, LI1/f;->n:LI1/g;

    .line 16
    invoke-static {v0, v3, p0, v1}, Lcom/google/android/apps/nexuslauncher/qsb/longpopup/SearchOptionsPopup;->m(Lcom/android/launcher3/BubbleTextView;LI1/g;LI1/f;Landroid/graphics/Rect;)Lcom/google/android/apps/nexuslauncher/qsb/longpopup/SearchOptionsPopup;

    move-result-object p0

    .line 17
    invoke-virtual {v2, p0}, Lcom/google/android/apps/nexuslauncher/NexusLauncherActivity;->A(Lcom/google/android/apps/nexuslauncher/qsb/longpopup/SearchOptionsPopup;)V
...
.method public k(Lcom/android/launcher3/dragndrop/BaseItemDragListener;Landroid/view/View;)V
    ...
    invoke-virtual {v0, v1}, LH1/q;->e(Z)V
    ...
    invoke-direct {p1, p0, p2}, LI1/d;-><init>(LI1/f;Landroid/view/View;)V
...
.method public onActivityDestroyed(Landroid/app/Activity;)V
    ...
    .line 1
    invoke-virtual {p0, p1}, LI1/f;->i(Landroid/app/Activity;)V
...
.method public onConfigurationChanged(Landroid/content/res/Configuration;)V
    ...
    .line 1
    iget-object v0, p0, LI1/f;->i:Landroid/content/res/Configuration;
...
.method public onDismiss(Landroid/content/DialogInterface;)V
    ...
    .line 1
    iget-object p1, p0, LI1/f;->b:Lcom/google/android/apps/nexuslauncher/NexusLauncherActivity;

    const/4 v0, 0x0

    invoke-virtual {p1, v0}, Lcom/google/android/apps/nexuslauncher/NexusLauncherActivity;->A(Lcom/google/android/apps/nexuslauncher/qsb/longpopup/SearchOptionsPopup;)V

    .line 2
    iget-object p1, p0, LI1/f;->h:Landroid/app/Application;
    ...
    .line 4
    iget-object p1, p0, LI1/f;->j:Lcom/android/launcher3/dragndrop/DragController;
...
.method public onDrag(Landroid/view/View;Landroid/view/DragEvent;)Z
    ...
    .line 2
    iget-object p1, p0, LI1/f;->d:LH1/I;

    iget-object v1, p0, LI1/f;->b:Lcom/google/android/apps/nexuslauncher/NexusLauncherActivity;

    invoke-virtual {p1, v1, p2, p0}, LH1/I;->j(Lcom/android/launcher3/Launcher;Landroid/view/DragEvent;Lcom/android/launcher3/dragndrop/DragOptions$PreDragCondition;)Z
    ...
    .line 3
    :cond_1
    iget-object p0, p0, LI1/f;->j:Lcom/android/launcher3/dragndrop/DragController;
...
.method public onDraw()V
    ...
    invoke-direct {v1, p0}, LI1/b;-><init>(LI1/f;)V
    ...
    invoke-direct {v1, p0}, LI1/c;-><init>(LI1/f;)V
...
.method public onPreDragEnd(Lcom/android/launcher3/DropTarget$DragObject;Z)V
    ...
    .line 1
    iput-boolean p1, p0, LI1/f;->o:Z

    .line 2
    iget-object p2, p0, LI1/f;->b:Lcom/google/android/apps/nexuslauncher/NexusLauncherActivity;
    ...
    .line 3
    iget-object p2, p0, LI1/f;->g:Lcom/android/launcher3/util/SystemUiController;
    ...
    invoke-virtual {p2}, Lcom/google/android/apps/nexuslauncher/NexusLauncherActivity;->x()LH1/q;

    move-result-object p2

    invoke-virtual {p2, p1}, LH1/q;->e(Z)V
