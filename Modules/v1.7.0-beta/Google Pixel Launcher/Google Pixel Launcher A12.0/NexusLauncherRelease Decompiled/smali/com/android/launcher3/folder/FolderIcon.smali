...
.method public static synthetic b(Lcom/android/launcher3/folder/FolderIcon;Lcom/android/launcher3/folder/FolderNameInfos;Lcom/android/launcher3/logging/InstanceId;)V
    .locals 0
...
.method public static synthetic c(Lcom/android/launcher3/folder/FolderIcon;Lcom/android/launcher3/DropTarget$DragObject;Lcom/android/launcher3/folder/FolderNameInfos;ILcom/android/launcher3/model/data/WorkspaceItemInfo;)V
    .locals 0
...
.method public static synthetic d(Lcom/android/launcher3/folder/FolderIcon;ILcom/android/launcher3/model/data/WorkspaceItemInfo;)V
    .locals 0
...
.method public drawDot(Landroid/graphics/Canvas;)V
    ...
    invoke-static {p0, v0, v2}, Lcom/android/launcher3/BubbleTextView;->getIconBounds(Landroid/view/View;Landroid/graphics/Rect;I)V
...
.method public final onDrop(Lcom/android/launcher3/model/data/WorkspaceItemInfo;Lcom/android/launcher3/DropTarget$DragObject;Landroid/graphics/Rect;FIZ)V
    ...
    .line 8
    invoke-virtual {v6, v7, v8}, Lcom/android/launcher3/views/BaseDragLayer;->getViewRectRelativeToSelf(Landroid/view/View;Landroid/graphics/Rect;)V
    ...
    .line 16
    invoke-virtual {v6, v1, v9}, Lcom/android/launcher3/views/BaseDragLayer;->getDescendantRectRelativeToSelf(Landroid/view/View;Landroid/graphics/Rect;)F
    ...
    .line 22
    iget-object v14, v1, Lcom/android/launcher3/folder/FolderIcon;->mInfo:Lcom/android/launcher3/model/data/FolderInfo;

    invoke-virtual {v14, v5, v0, v11}, Lcom/android/launcher3/model/data/FolderInfo;->add(Lcom/android/launcher3/model/data/WorkspaceItemInfo;IZ)V
    ...
    invoke-virtual {v1, v11}, Lcom/android/launcher3/folder/FolderIcon;->getPreviewItemsOnPage(I)Ljava/util/List;
    ...
    .line 25
    iget-object v4, v1, Lcom/android/launcher3/folder/FolderIcon;->mCurrentPreviewItems:Ljava/util/List;

    invoke-interface {v13, v4}, Ljava/util/List;->equals(Ljava/lang/Object;)Z
    ...
    .line 27
    :cond_2
    iget-object v4, v1, Lcom/android/launcher3/folder/FolderIcon;->mPreviewItemManager:Lcom/android/launcher3/folder/PreviewItemManager;

    invoke-virtual {v4, v0, v15}, Lcom/android/launcher3/folder/PreviewItemManager;->hidePreviewItem(IZ)V
    ...
    invoke-virtual {v4, v13, v14, v5}, Lcom/android/launcher3/folder/PreviewItemManager;->onDrop(Ljava/util/List;Ljava/util/List;Lcom/android/launcher3/model/data/WorkspaceItemInfo;)V
    ...
    .line 29
    :cond_3
    invoke-virtual {v1, v5, v11}, Lcom/android/launcher3/folder/FolderIcon;->removeItem(Lcom/android/launcher3/model/data/WorkspaceItemInfo;Z)V
    ...
    invoke-virtual {v13, v5, v4, v15}, Lcom/android/launcher3/model/data/FolderInfo;->add(Lcom/android/launcher3/model/data/WorkspaceItemInfo;IZ)V
    ...
    .line 31
    invoke-virtual {v1, v4, v3, v14}, Lcom/android/launcher3/folder/FolderIcon;->getLocalCenterForIndex(II[I)F
    ...
    .line 37
    iget-object v11, v2, Lcom/android/launcher3/DropTarget$DragObject;->dragSource:Lcom/android/launcher3/DragSource;

    instance-of v11, v11, Lcom/android/launcher3/allapps/AllAppsContainerView;

    if-eqz v11, :cond_7

    .line 38
    iget-object v11, v1, Lcom/android/launcher3/folder/FolderIcon;->mActivity:Lcom/android/launcher3/views/ActivityContext;
    ...
    .line 39
    iget v12, v11, Lcom/android/launcher3/DeviceProfile;->iconSizePx:I
    ...
    iget v11, v11, Lcom/android/launcher3/DeviceProfile;->allAppsIconSizePx:I
    ...
    .line 40
    sget-object v16, Lcom/android/launcher3/anim/Interpolators;->DEACCEL_2:Landroid/view/animation/Interpolator;

    sget-object v17, Lcom/android/launcher3/anim/Interpolators;->ACCEL_2:Landroid/view/animation/Interpolator;

    new-instance v13, Lx0/o;

    invoke-direct {v13, v1, v4, v5}, Lx0/o;-><init>(Lcom/android/launcher3/folder/FolderIcon;ILcom/android/launcher3/model/data/WorkspaceItemInfo;)V
    ...
    invoke-virtual/range {v6 .. v20}, Lcom/android/launcher3/dragndrop/DragLayer;->animateView(Lcom/android/launcher3/dragndrop/DragView;Landroid/graphics/Rect;Landroid/graphics/Rect;FFFFFILandroid/view/animation/Interpolator;Landroid/view/animation/Interpolator;Ljava/lang/Runnable;ILandroid/view/View;)V
    ...
    invoke-virtual {v0, v4, v3}, Lcom/android/launcher3/folder/PreviewItemManager;->hidePreviewItem(IZ)V
    ...
    invoke-direct/range {v0 .. v5}, Lx0/p;-><init>(Lcom/android/launcher3/folder/FolderIcon;Lcom/android/launcher3/DropTarget$DragObject;Lcom/android/launcher3/folder/FolderNameInfos;ILcom/android/launcher3/model/data/WorkspaceItemInfo;)V
    ...
    invoke-virtual {v1, v4, v5, v3, v0}, Lcom/android/launcher3/folder/FolderIcon;->showFinalView(ILcom/android/launcher3/model/data/WorkspaceItemInfo;Lcom/android/launcher3/folder/FolderNameInfos;Lcom/android/launcher3/logging/InstanceId;)V
...
.method public onRemove(Ljava/util/List;)V
    ...
    invoke-direct {v2, v1}, Lx0/s;-><init>(Lcom/android/launcher3/views/ActivityContext;)V
    ...
    invoke-direct {v2, v1}, Lx0/r;-><init>(Lcom/android/launcher3/dot/FolderDotInfo;)V
...
.method public final showFinalView(ILcom/android/launcher3/model/data/WorkspaceItemInfo;Lcom/android/launcher3/folder/FolderNameInfos;Lcom/android/launcher3/logging/InstanceId;)V
    ...
    invoke-direct {p1, p0, p3, p4}, Lx0/q;-><init>(Lcom/android/launcher3/folder/FolderIcon;Lcom/android/launcher3/folder/FolderNameInfos;Lcom/android/launcher3/logging/InstanceId;)V
