...
.field public static final ENABLE_OVERVIEW_CONTENT_PUSH:Lcom/android/launcher3/config/FeatureFlags$BooleanFlag;
...
.field public static final ENABLE_OVERVIEW_SHARE:Lcom/android/launcher3/config/FeatureFlags$BooleanFlag;
...
.field public static final ENABLE_QUICK_CAPTURE_GESTURE:Lcom/android/launcher3/config/FeatureFlags$BooleanFlag;

.field public static final ENABLE_QUICK_CAPTURE_WINDOW:Lcom/android/launcher3/config/FeatureFlags$BooleanFlag;
...
.field public static final ENABLE_SMARTSPACE_ENHANCED:Lcom/android/launcher3/config/FeatureFlags$BooleanFlag;

.field public static final ENABLE_SMARTSPACE_FEEDBACK:Lcom/android/launcher3/config/FeatureFlags$BooleanFlag;

.field public static final ENABLE_SMARTSPACE_UNIVERSAL:Lcom/android/launcher3/config/FeatureFlags$BooleanFlag;

.field public static final ENABLE_SPLIT_SELECT:Lcom/android/launcher3/config/FeatureFlags$BooleanFlag;

.field public static final ENABLE_SUGGESTED_ACTIONS_OVERVIEW:Lcom/android/launcher3/config/FeatureFlags$BooleanFlag;
...
.field public static final FORCE_LOCAL_OVERSCROLL_PLUGIN:Lcom/android/launcher3/config/FeatureFlags$BooleanFlag;
...
.field public static final MULTI_DB_GRID_MIRATION_ALGO:Lcom/android/launcher3/config/FeatureFlags$BooleanFlag;
...
.field public static final PROTOTYPE_APP_CLOSE:Lcom/android/launcher3/config/FeatureFlags$BooleanFlag;

.field public static final QUICKSTEP_SPRINGS:Lcom/android/launcher3/config/FeatureFlags$BooleanFlag;

.field public static final SEPARATE_RECENTS_ACTIVITY:Lcom/android/launcher3/config/FeatureFlags$BooleanFlag;

.field public static final UNSTABLE_SPRINGS:Lcom/android/launcher3/config/FeatureFlags$BooleanFlag;
...
.method public static constructor <clinit>()V
    ...
    const-string v0, "QUICKSTEP_SPRINGS"

    const-string v3, "Enable springs for quickstep animations"
    ...
    sput-object v0, Lcom/android/launcher3/config/FeatureFlags;->QUICKSTEP_SPRINGS:Lcom/android/launcher3/config/FeatureFlags$BooleanFlag;

    const-string v0, "UNSTABLE_SPRINGS"

    const-string v3, "Enable unstable springs for quickstep animations"
    ...
    sput-object v0, Lcom/android/launcher3/config/FeatureFlags;->UNSTABLE_SPRINGS:Lcom/android/launcher3/config/FeatureFlags$BooleanFlag;
    ...
    const-string v3, "ENABLE_SUGGESTED_ACTIONS_OVERVIEW"

    const-string v4, "Show chip hints on the overview screen"

    invoke-direct {v0, v3, v1, v4}, Lcom/android/launcher3/uioverrides/DeviceFlag;-><init>(Ljava/lang/String;ZLjava/lang/String;)V

    sput-object v0, Lcom/android/launcher3/config/FeatureFlags;->ENABLE_SUGGESTED_ACTIONS_OVERVIEW:Lcom/android/launcher3/config/FeatureFlags$BooleanFlag;
    ...
    const-string v0, "ENABLE_QUICK_CAPTURE_GESTURE"

    const-string v3, "Swipe from right to left to quick capture"
    ...
    sput-object v0, Lcom/android/launcher3/config/FeatureFlags;->ENABLE_QUICK_CAPTURE_GESTURE:Lcom/android/launcher3/config/FeatureFlags$BooleanFlag;

    const-string v0, "ENABLE_QUICK_CAPTURE_WINDOW"

    const-string v3, "Use window to host quick capture"
    ...
    sput-object v0, Lcom/android/launcher3/config/FeatureFlags;->ENABLE_QUICK_CAPTURE_WINDOW:Lcom/android/launcher3/config/FeatureFlags$BooleanFlag;

    const-string v0, "FORCE_LOCAL_OVERSCROLL_PLUGIN"

    const-string v3, "Use a launcher-provided OverscrollPlugin if available"
    ...
    sput-object v0, Lcom/android/launcher3/config/FeatureFlags;->FORCE_LOCAL_OVERSCROLL_PLUGIN:Lcom/android/launcher3/config/FeatureFlags$BooleanFlag;
    ...
    const-string v0, "MULTI_DB_GRID_MIRATION_ALGO"

    const-string v3, "Use the multi-db grid migration algorithm"
    ...
    sput-object v0, Lcom/android/launcher3/config/FeatureFlags;->MULTI_DB_GRID_MIRATION_ALGO:Lcom/android/launcher3/config/FeatureFlags$BooleanFlag;
    ...
    sput-object v0, Lcom/android/launcher3/config/FeatureFlags;->ENABLE_OVERVIEW_SHARE:Lcom/android/launcher3/config/FeatureFlags$BooleanFlag;
    ...
    const-string v0, "ENABLE_OVERVIEW_CONTENT_PUSH"

    const-string v3, "Show Content Push button in Overview Actions"
    ...
    sput-object v0, Lcom/android/launcher3/config/FeatureFlags;->ENABLE_OVERVIEW_CONTENT_PUSH:Lcom/android/launcher3/config/FeatureFlags$BooleanFlag;
    ...
    const-string v0, "ENABLE_SMARTSPACE_UNIVERSAL"

    const-string v3, "Replace Smartspace with a version rendered by System UI."
    ...
    sput-object v0, Lcom/android/launcher3/config/FeatureFlags;->ENABLE_SMARTSPACE_UNIVERSAL:Lcom/android/launcher3/config/FeatureFlags$BooleanFlag;

    const-string v0, "ENABLE_SMARTSPACE_ENHANCED"

    const-string v3, "Replace Smartspace with the enhanced version. Ignored if ENABLE_SMARTSPACE_UNIVERSAL is enabled."
    ...
    sput-object v0, Lcom/android/launcher3/config/FeatureFlags;->ENABLE_SMARTSPACE_ENHANCED:Lcom/android/launcher3/config/FeatureFlags$BooleanFlag;

    const-string v0, "ENABLE_SMARTSPACE_FEEDBACK"

    const-string v3, "Adds a menu option to send feedback for Enhanced Smartspace."
    ...
    sput-object v0, Lcom/android/launcher3/config/FeatureFlags;->ENABLE_SMARTSPACE_FEEDBACK:Lcom/android/launcher3/config/FeatureFlags$BooleanFlag;
    ...
    const-string v0, "PROTOTYPE_APP_CLOSE"

    const-string v3, "Enables new app close"
    ...
    sput-object v0, Lcom/android/launcher3/config/FeatureFlags;->PROTOTYPE_APP_CLOSE:Lcom/android/launcher3/config/FeatureFlags$BooleanFlag;
