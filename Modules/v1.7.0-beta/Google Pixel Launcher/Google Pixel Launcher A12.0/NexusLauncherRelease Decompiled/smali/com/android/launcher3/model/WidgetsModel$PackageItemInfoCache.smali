...
# virtual methods
.method public getOrCreate(Lcom/android/launcher3/model/WidgetsModel$WidgetPackageOrCategoryKey;)Lcom/android/launcher3/model/data/PackageItemInfo;
    .locals 3
    ...
    iget-object v1, p1, Lcom/android/launcher3/model/WidgetsModel$WidgetPackageOrCategoryKey;->mPackage:Ljava/lang/String;

    iget v2, p1, Lcom/android/launcher3/model/WidgetsModel$WidgetPackageOrCategoryKey;->mCategory:I

    invoke-direct {v0, v1, v2}, Lcom/android/launcher3/model/data/PackageItemInfo;-><init>(Ljava/lang/String;I)V

    .line 3
    iget-object v1, p1, Lcom/android/launcher3/model/WidgetsModel$WidgetPackageOrCategoryKey;->mUser:Landroid/os/UserHandle;
