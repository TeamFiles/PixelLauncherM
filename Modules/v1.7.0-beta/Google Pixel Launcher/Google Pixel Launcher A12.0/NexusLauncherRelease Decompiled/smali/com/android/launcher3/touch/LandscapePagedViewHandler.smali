...
.method public setLayoutParamsForTaskMenuOptionItem(Landroid/widget/LinearLayout$LayoutParams;Landroid/widget/LinearLayout;Lcom/android/launcher3/DeviceProfile;)V
    ...
    .line 5
    sget p1, Lcom/android/launcher3/R$id;->text:I

    invoke-virtual {p2, p1}, Landroid/widget/LinearLayout;->findViewById(I)Landroid/view/View;

    move-result-object p1

    invoke-static {p1, p0}, Lcom/android/launcher3/Utilities;->setStartMarginForView(Landroid/view/View;I)V

    .line 6
    sget p1, Lcom/android/launcher3/R$id;->icon:I
