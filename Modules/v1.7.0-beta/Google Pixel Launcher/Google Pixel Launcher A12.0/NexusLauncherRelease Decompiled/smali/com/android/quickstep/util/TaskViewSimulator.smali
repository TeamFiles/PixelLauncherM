...
.field private final mIsForLiveTile:Z
...
.method public constructor <init>(Landroid/content/Context;Lcom/android/quickstep/BaseActivityInterface;)V
    ...
    .line 1
    invoke-direct {p0, p1, p2, v0}, Lcom/android/quickstep/util/TaskViewSimulator;-><init>(Landroid/content/Context;Lcom/android/quickstep/BaseActivityInterface;Z)V

    return-void
.end method

.method public constructor <init>(Landroid/content/Context;Lcom/android/quickstep/BaseActivityInterface;Z)V
    .locals 1
    ...
    .line 25
    iput-boolean p3, p0, Lcom/android/quickstep/util/TaskViewSimulator;->mIsForLiveTile:Z

    .line 26
    new-instance p3, Lk1/D;

    invoke-direct {p3, p1, p2}, Lk1/D;-><init>(Landroid/content/Context;Lcom/android/quickstep/BaseActivityInterface;)V

    const-string p2, ""

    invoke-static {p2, p3}, Lcom/android/launcher3/util/TraceHelper;->allowIpcs(Ljava/lang/String;Ljava/util/function/Supplier;)Ljava/lang/Object;
    ...
    .line 27
    invoke-virtual {p2, p3}, Lcom/android/quickstep/util/RecentsOrientedState;->setGestureActive(Z)Z
...
.method public apply(Lcom/android/quickstep/util/TransformParams;)V
    ...
    iget-object v8, p0, Lcom/android/quickstep/util/TaskViewSimulator;->mPositionHelper:Lcom/android/quickstep/views/TaskThumbnailView$PreviewPositionHelper;

    .line 16
    invoke-virtual/range {v3 .. v8}, Lcom/android/quickstep/views/TaskView$FullscreenDrawParams;->setProgress(FFILcom/android/launcher3/DeviceProfile;Lcom/android/quickstep/views/TaskThumbnailView$PreviewPositionHelper;)V
    ...
    invoke-interface {v0, v4, v5, v6}, Lcom/android/launcher3/touch/PagedOrientationHandler;->set(Ljava/lang/Object;Lcom/android/launcher3/touch/PagedOrientationHandler$Float2DAction;F)V
...
.method public applyWindowToHomeRotation(Landroid/graphics/Matrix;)V
    ...
    iget v2, v1, Lcom/android/launcher3/DeviceProfile;->windowX:I
    ...
    .line 6
    iget-object p0, p0, Lcom/android/quickstep/util/TaskViewSimulator;->mRunningTargetWindowPosition:Landroid/graphics/Point;
...
.method public onBuildTargetParams(Lcom/android/systemui/shared/system/SyncRtSurfaceTransactionApplierCompat$SurfaceParams$Builder;Lcom/android/systemui/shared/system/RemoteAnimationTargetCompat;Lcom/android/quickstep/util/TransformParams;)V
    ...
    iget-boolean p2, p0, Lcom/android/quickstep/util/TaskViewSimulator;->mIsForLiveTile:Z
