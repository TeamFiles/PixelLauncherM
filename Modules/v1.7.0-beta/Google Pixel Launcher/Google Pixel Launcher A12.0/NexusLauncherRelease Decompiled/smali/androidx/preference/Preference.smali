...
.field public mListener:Lc0/r;

.field public mOnChangeListener:Lc0/s;

.field public mOnClickListener:Lc0/t;

.field public mOnCopyListener:Lc0/u;
...
.field public mPreferenceDataStore:Lc0/w;

.field public mPreferenceManager:Lc0/Z;
...
.field public mSummaryProvider:Lc0/v;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;II)V
    ...
    invoke-direct {v4, p0}, Lc0/p;-><init>(Landroidx/preference/Preference;)V
    ...
    invoke-static {p1, p2, p3, v1}, LC/t;->n(Landroid/content/res/TypedArray;III)I
    ...
    invoke-static {p1, p2, p3}, LC/t;->p(Landroid/content/res/TypedArray;II)Ljava/lang/CharSequence;
    ...
    invoke-static {p1, p2, p3, v0}, LC/t;->d(Landroid/content/res/TypedArray;III)I
    ...
    invoke-static {p1, p2, p3, v3}, LC/t;->n(Landroid/content/res/TypedArray;III)I
    ...
    invoke-static {p1, p2, p3, v2}, LC/t;->b(Landroid/content/res/TypedArray;IIZ)Z
    ...
    invoke-static {p1, p2, p2, p3}, LC/t;->b(Landroid/content/res/TypedArray;IIZ)Z
    ...
    invoke-static {p1, p2, p3, v1}, LC/t;->b(Landroid/content/res/TypedArray;IIZ)Z
    ...
    invoke-static {p1, p2, p2, v2}, LC/t;->b(Landroid/content/res/TypedArray;IIZ)Z
    ...
    invoke-static {p1, p2, p2, v1}, LC/t;->b(Landroid/content/res/TypedArray;IIZ)Z
...
.method public callChangeListener(Ljava/lang/Object;)Z
    ...
    .line 1
    iget-object v0, p0, Landroidx/preference/Preference;->mOnChangeListener:Lc0/s;

    if-eqz v0, :cond_1

    invoke-interface {v0, p0, p1}, Lc0/s;->a(Landroidx/preference/Preference;Ljava/lang/Object;)Z
...
.method public final dispatchSetInitialValue()V
    ...
    .line 1
    invoke-virtual {p0}, Landroidx/preference/Preference;->getPreferenceDataStore()Lc0/w;
...
.method public findPreferenceInHierarchy(Ljava/lang/String;)Landroidx/preference/Preference;
    ...
    .line 1
    iget-object p0, p0, Landroidx/preference/Preference;->mPreferenceManager:Lc0/Z;
    ...
    .line 2
    :cond_0
    invoke-virtual {p0, p1}, Lc0/Z;->b(Ljava/lang/CharSequence;)Landroidx/preference/Preference;
...
.method public getPersistedBoolean(Z)Z
    ...
    invoke-virtual {v0, p0, p1}, Lc0/w;->getBoolean(Ljava/lang/String;Z)Z
    ...
    .line 4
    :cond_1
    iget-object v0, p0, Landroidx/preference/Preference;->mPreferenceManager:Lc0/Z;

    invoke-virtual {v0}, Lc0/Z;->k()Landroid/content/SharedPreferences;
...
.method public getPersistedInt(I)I
    ...
    invoke-virtual {v0, p0, p1}, Lc0/w;->getInt(Ljava/lang/String;I)I
...
.method public getPersistedString(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-virtual {v0, p0, p1}, Lc0/w;->getString(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
...
.method public getPersistedStringSet(Ljava/util/Set;)Ljava/util/Set;
    ...
    invoke-virtual {v0, p0, p1}, Lc0/w;->getStringSet(Ljava/lang/String;Ljava/util/Set;)Ljava/util/Set;
...
.method public getPreferenceDataStore()Lc0/w;
    .locals 1

    .line 1
    iget-object v0, p0, Landroidx/preference/Preference;->mPreferenceDataStore:Lc0/w;
    ...
    .line 3
    invoke-virtual {p0}, Lc0/Z;->i()Lc0/w;
...
.method public getPreferenceManager()Lc0/Z;
    .locals 0
...
.method public getSharedPreferences()Landroid/content/SharedPreferences;
    ...
    invoke-virtual {p0}, Lc0/Z;->k()Landroid/content/SharedPreferences;
...
.method public getSummary()Ljava/lang/CharSequence;
    ...
    .line 1
    invoke-virtual {p0}, Landroidx/preference/Preference;->getSummaryProvider()Lc0/v;
    ...
    invoke-interface {v0, p0}, Lc0/v;->a(Landroidx/preference/Preference;)Ljava/lang/CharSequence;
...
.method public final getSummaryProvider()Lc0/v;
    .locals 0

    .line 1
    iget-object p0, p0, Landroidx/preference/Preference;->mSummaryProvider:Lc0/v;
...
.method public notifyChanged()V
    ...
    .line 1
    iget-object v0, p0, Landroidx/preference/Preference;->mListener:Lc0/r;

    if-eqz v0, :cond_0

    .line 2
    invoke-interface {v0, p0}, Lc0/r;->b(Landroidx/preference/Preference;)V
...
.method public notifyHierarchyChanged()V
    ...
    .line 2
    invoke-interface {v0, p0}, Lc0/r;->a(Landroidx/preference/Preference;)V
...
.method public onAttachedToHierarchy(Lc0/Z;)V
    .locals 2

    .line 1
    iput-object p1, p0, Landroidx/preference/Preference;->mPreferenceManager:Lc0/Z;
...
.method public onAttachedToHierarchy(Lc0/Z;J)V
    .locals 0
    ...
    .line 7
    :try_start_0
    invoke-virtual {p0, p1}, Landroidx/preference/Preference;->onAttachedToHierarchy(Lc0/Z;)V
    :try_end_0
...
.method public onBindViewHolder(Lc0/c0;)V
    ...
    .line 4
    invoke-virtual {p1, v1}, Lc0/c0;->a(I)Landroid/view/View;
    ...
    .line 11
    invoke-virtual {p1, v5}, Lc0/c0;->a(I)Landroid/view/View;
    ...
    .line 44
    iget-object v3, p0, Landroidx/preference/Preference;->mOnCopyListener:Lc0/u;
    ...
    invoke-direct {v3, p0}, Lc0/u;-><init>(Landroidx/preference/Preference;)V

    iput-object v3, p0, Landroidx/preference/Preference;->mOnCopyListener:Lc0/u;

    :cond_10
    if-eqz p1, :cond_11

    .line 46
    iget-object p0, p0, Landroidx/preference/Preference;->mOnCopyListener:Lc0/u;
    ...
    .line 48
    invoke-static {v0, v2}, LL/N;->s0(Landroid/view/View;Landroid/graphics/drawable/Drawable;)V
...
.method public performClick()V
    ...
    .line 4
    iget-object v0, p0, Landroidx/preference/Preference;->mOnClickListener:Lc0/t;

    if-eqz v0, :cond_1

    invoke-interface {v0, p0}, Lc0/t;->a(Landroidx/preference/Preference;)Z
    ...
    .line 5
    :cond_1
    invoke-virtual {p0}, Landroidx/preference/Preference;->getPreferenceManager()Lc0/Z;
    ...
    .line 6
    invoke-virtual {v0}, Lc0/Z;->g()Lc0/X;
    ...
    .line 7
    invoke-interface {v0, p0}, Lc0/X;->onPreferenceTreeClick(Landroidx/preference/Preference;)Z
...
.method public persistBoolean(Z)Z
    ...
    invoke-virtual {v0, p0, p1}, Lc0/w;->putBoolean(Ljava/lang/String;Z)V
    ...
    invoke-virtual {v0}, Lc0/Z;->d()Landroid/content/SharedPreferences$Editor;
...
.method public persistInt(I)Z
    ...
    invoke-virtual {v0, p0, p1}, Lc0/w;->putInt(Ljava/lang/String;I)V
...
.method public persistString(Ljava/lang/String;)Z
    ...
    invoke-virtual {v0, p0, p1}, Lc0/w;->putString(Ljava/lang/String;Ljava/lang/String;)V
...
.method public persistStringSet(Ljava/util/Set;)Z
    ...
    invoke-virtual {v0, p0, p1}, Lc0/w;->putStringSet(Ljava/lang/String;Ljava/util/Set;)V
...
.method public final setOnPreferenceChangeInternalListener(Lc0/r;)V
    .locals 0

    .line 1
    iput-object p1, p0, Landroidx/preference/Preference;->mListener:Lc0/r;

    return-void
.end method

.method public setOnPreferenceClickListener(Lc0/t;)V
    .locals 0

    .line 1
    iput-object p1, p0, Landroidx/preference/Preference;->mOnClickListener:Lc0/t;
...
.method public setPreferenceDataStore(Lc0/w;)V
    .locals 0

    .line 1
    iput-object p1, p0, Landroidx/preference/Preference;->mPreferenceDataStore:Lc0/w;
...
.method public final setSummaryProvider(Lc0/v;)V
    .locals 0

    .line 1
    iput-object p1, p0, Landroidx/preference/Preference;->mSummaryProvider:Lc0/v;
...
.method public final setVisible(Z)V
    ...
    .line 3
    iget-object p1, p0, Landroidx/preference/Preference;->mListener:Lc0/r;

    if-eqz p1, :cond_0

    .line 4
    invoke-interface {p1, p0}, Lc0/r;->d(Landroidx/preference/Preference;)V
